...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:rn,depthTest:!1,depthWrite:!1})}function id(i,e,t){const n=new Float32Array(wn),r=new z(0,1,0);return new qt({name:"SphericalGaussianBlur",defines:{n:wn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:rr(),fragmentShader:`
...
`)+`
`+f);const T=y+m+s,R=y+f+o,P=Ls(r,r.VERTEX_SHADER,T),b=Ls(r,r.FRAGMENT_SHADER,R);r.attachShader(S,P),r.attachShader(S,b),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function D(w){if(i.debug.checkShaderErrors){const I=r.getProgramInfoLog(S)||"",G=r.getShaderInfoLog(P)||"",k=r.getShaderInfoLog(b)||"",K=I.trim(),q=G.trim(),ne=k.trim();let H=!0,te=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,P,b);else{const ae=Is(r,P,"vertex"),Me=Is(r,b,"fragment");ot("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
}`;function Oh(i,e,t){let n=new co;const r=new Xe,a=new Xe,s=new lt,o=new nc({depthPacking:hl}),c=new ic,l={},u=t.maxTextureSize,d={[_n]:Tt,[Tt]:_n,[en]:en},h=new qt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:Nh,fragmentShader:Fh}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const g=new gn;g.setAttribute("position",new Xt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new ln(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hs;let f=this.type;this.render=function(b,D,B){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const M=i.getRenderTarget(),v=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),I=i.state;I.setBlending(rn),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const G=f!==$t&&this.type===$t,k=f===$t&&this.type!==$t;for(let K=0,q=b.length;K<q;K++){const ne=b[K],H=ne.shadow;if(H===void 0){Ue("WebGLShadowMap:",ne,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const te=H.getFrameExtents();if(r.multiply(te),a.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(a.x=Math.floor(u/te.x),r.x=a.x*te.x,H.mapSize.x=a.x),r.y>u&&(a.y=Math.floor(u/te.y),r.y=a.y*te.y,H.mapSize.y=a.y)),H.map===null||G===!0||k===!0){const Me=this.type!==$t?{minFilter:wt,magFilter:wt}:{};H.map!==null&&H.map.dispose(),H.map=new In(r.x,r.y,Me),H.map.texture.name=ne.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const ae=H.getViewportCount();for(let Me=0;Me<ae;Me++){const He=H.getViewport(Me);s.set(a.x*He.x,a.y*He.y,a.x*He.z,a.y*He.w),I.viewport(s),H.updateMatrices(ne,Me),n=H.getFrustum(),R(D,B,H.camera,ne,this.type)}H.isPointLightShadow!==!0&&this.type===$t&&y(H,B),H.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(M,v,w)};function y(b,D){const B=e.update(S);h.defines.VSM_SAMPLES!==b.blurSamples&&(h.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new In(r.x,r.y)),h.uniforms.shadow_pass.value=b.map.texture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(D,null,B,h,S,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(D,null,B,p,S,null)}function T(b,D,B,M){let v=null;const w=B.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(w!==void 0)v=w;else if(v=B.isPointLight===!0?c:o,i.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const I=v.uuid,G=D.uuid;let k=l[I];k===void 0&&(k={},l[I]=k);let K=k[G];K===void 0&&(K=v.clone(),k[G]=K,D.addEventListener("dispose",P)),v=K}if(v.visible=D.visible,v.wireframe=D.wireframe,M===$t?v.side=D.shadowSide!==null?D.shadowSide:D.side:v.side=D.shadowSide!==null?D.shadowSide:d[D.side],v.alphaMap=D.alphaMap,v.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,v.map=D.map,v.clipShadows=D.clipShadows,v.clippingPlanes=D.clippingPlanes,v.clipIntersection=D.clipIntersection,v.displacementMap=D.displacementMap,v.displacementScale=D.displacementScale,v.displacementBias=D.displacementBias,v.wireframeLinewidth=D.wireframeLinewidth,v.linewidth=D.linewidth,B.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const I=i.properties.get(v);I.light=B}return v}function R(b,D,B,M,v){if(b.visible===!1)return;if(b.layers.test(D.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&v===$t)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,b.matrixWorld);const G=e.update(b),k=b.material;if(Array.isArray(k)){const K=G.groups;for(let q=0,ne=K.length;q<ne;q++){const H=K[q],te=k[H.materialIndex];if(te&&te.visible){const ae=T(b,te,M,v);b.onBeforeShadow(i,b,D,B,G,ae,H),i.renderBufferDirect(B,null,G,ae,b,H),b.onAfterShadow(i,b,D,B,G,ae,H)}}}else if(k.visible){const K=T(b,k,M,v);b.onBeforeShadow(i,b,D,B,G,K,null),i.renderBufferDirect(B,null,G,K,b,null),b.onAfterShadow(i,b,D,B,G,K,null)}}const I=b.children;for(let G=0,k=I.length;G<k;G++)R(I[G],D,B,M,v)}function P(b){b.target.removeEventListener("dispose",P);for(const B in l){const M=l[B],v=b.target.uuid;v in M&&(M[v].dispose(),delete M[v])}}}const Bh={[Gr]:Hr,[kr]:qr,[Wr]:Yr,[$n]:Xr,[Hr]:Gr,[qr]:kr,[Yr]:Wr,[Xr]:$n};function zh(i,e){function t(){let C=!1;const le=new lt;let ie=null;const re=new lt(0,0,0,0);return{setMask:function(Q){ie!==Q&&!C&&(i.colorMask(Q,Q,Q,Q),ie=Q)},setLocked:function(Q){C=Q},setClear:function(Q,Y,he,we,et){et===!0&&(Q*=we,Y*=we,he*=we),le.set(Q,Y,he,we),re.equals(le)===!1&&(i.clearColor(Q,Y,he,we),re.copy(le))},reset:function(){C=!1,ie=null,re.set(-1,0,0,0)}}}function n(){let C=!1,le=!1,ie=null,re=null,Q=null;return{setReversed:function(Y){if(le!==Y){const he=e.get("EXT_clip_control");Y?he.clipControlEXT(he.LOWER_LEFT_EXT,he.ZERO_TO_ONE_EXT):he.clipControlEXT(he.LOWER_LEFT_EXT,he.NEGATIVE_ONE_TO_ONE_EXT),le=Y;const we=Q;Q=null,this.setClear(we)}},getReversed:function(){return le},setTest:function(Y){Y?J(i.DEPTH_TEST):de(i.DEPTH_TEST)},setMask:function(Y){ie!==Y&&!C&&(i.depthMask(Y),ie=Y)},setFunc:function(Y){if(le&&(Y=Bh[Y]),re!==Y){switch(Y){case Gr:i.depthFunc(i.NEVER);break;case Hr:i.depthFunc(i.ALWAYS);break;case kr:i.depthFunc(i.LESS);break;case $n:i.depthFunc(i.LEQUAL);break;case Wr:i.depthFunc(i.EQUAL);break;case Xr:i.depthFunc(i.GEQUAL);break;case qr:i.depthFunc(i.GREATER);break;case Yr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}re=Y}},setLocked:function(Y){C=Y},setClear:function(Y){Q!==Y&&(le&&(Y=1-Y),i.clearDepth(Y),Q=Y)},reset:function(){C=!1,ie=null,re=null,Q=null,le=!1}}}function r(){let C=!1,le=null,ie=null,re=null,Q=null,Y=null,he=null,we=null,et=null;return{setTest:function(Ye){C||(Ye?J(i.STENCIL_TEST):de(i.STENCIL_TEST))},setMask:function(Ye){le!==Ye&&!C&&(i.stencilMask(Ye),le=Ye)},setFunc:function(Ye,Gt,It){(ie!==Ye||re!==Gt||Q!==It)&&(i.stencilFunc(Ye,Gt,It),ie=Ye,re=Gt,Q=It)},setOp:function(Ye,Gt,It){(Y!==Ye||he!==Gt||we!==It)&&(i.stencilOp(Ye,Gt,It),Y=Ye,he=Gt,we=It)},setLocked:function(Ye){C=Ye},setClear:function(Ye){et!==Ye&&(i.clearStencil(Ye),et=Ye)},reset:function(){C=!1,le=null,ie=null,re=null,Q=null,Y=null,he=null,we=null,et=null}}}const a=new t,s=new n,o=new r,c=new WeakMap,l=new WeakMap;let u={},d={},h=new WeakMap,p=[],g=null,S=!1,m=null,f=null,y=null,T=null,R=null,P=null,b=null,D=new Pe(0,0,0),B=0,M=!1,v=null,w=null,I=null,G=null,k=null;const K=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let q=!1,ne=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(ne=parseFloat(/^WebGL (\d)/.exec(H)[1]),q=ne>=1):H.indexOf("OpenGL ES")!==-1&&(ne=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),q=ne>=2);let te=null,ae={};const Me=i.getParameter(i.SCISSOR_BOX),He=i.getParameter(i.VIEWPORT),qe=new lt().fromArray(Me),je=new lt().fromArray(He);function Qe(C,le,ie,re){const Q=new Uint8Array(4),Y=i.createTexture();i.bindTexture(C,Y),i.texParameteri(C,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(C,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let he=0;he<ie;he++)C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY?i.texImage3D(le,0,i.RGBA,1,1,re,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(le+he,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return Y}const X={};X[i.TEXTURE_2D]=Qe(i.TEXTURE_2D,i.TEXTURE_2D,1),X[i.TEXTURE_CUBE_MAP]=Qe(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),X[i.TEXTURE_2D_ARRAY]=Qe(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),X[i.TEXTURE_3D]=Qe(i.TEXTURE_3D,i.TEXTURE_3D,1,1),a.setClear(0,0,0,1),s.setClear(1),o.setClear(0),J(i.DEPTH_TEST),s.setFunc($n),Be(!1),ze(qa),J(i.CULL_FACE),tt(rn);function J(C){u[C]!==!0&&(i.enable(C),u[C]=!0)}function de(C){u[C]!==!1&&(i.disable(C),u[C]=!1)}function Le(C,le){return d[C]!==le?(i.bindFramebuffer(C,le),d[C]=le,C===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=le),C===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=le),!0):!1}function ge(C,le){let ie=p,re=!1;if(C){ie=h.get(le),ie===void 0&&(ie=[],h.set(le,ie));const Q=C.textures;if(ie.length!==Q.length||ie[0]!==i.COLOR_ATTACHMENT0){for(let Y=0,he=Q.length;Y<he;Y++)ie[Y]=i.COLOR_ATTACHMENT0+Y;ie.length=Q.length,re=!0}}else ie[0]!==i.BACK&&(ie[0]=i.BACK,re=!0);re&&i.drawBuffers(ie)}function Oe(C){return g!==C?(i.useProgram(C),g=C,!0):!1}const pt={[Cn]:i.FUNC_ADD,[zo]:i.FUNC_SUBTRACT,[Vo]:i.FUNC_REVERSE_SUBTRACT};pt[Go]=i.MIN,pt[Ho]=i.MAX;const Fe={[ko]:i.ZERO,[Wo]:i.ONE,[Xo]:i.SRC_COLOR,[zr]:i.SRC_ALPHA,[jo]:i.SRC_ALPHA_SATURATE,[Zo]:i.DST_COLOR,[Yo]:i.DST_ALPHA,[qo]:i.ONE_MINUS_SRC_COLOR,[Vr]:i.ONE_MINUS_SRC_ALPHA,[Jo]:i.ONE_MINUS_DST_COLOR,[Ko]:i.ONE_MINUS_DST_ALPHA,[Qo]:i.CONSTANT_COLOR,[$o]:i.ONE_MINUS_CONSTANT_COLOR,[el]:i.CONSTANT_ALPHA,[tl]:i.ONE_MINUS_CONSTANT_ALPHA};function tt(C,le,ie,re,Q,Y,he,we,et,Ye){if(C===rn){S===!0&&(de(i.BLEND),S=!1);return}if(S===!1&&(J(i.BLEND),S=!0),C!==Bo){if(C!==m||Ye!==M){if((f!==Cn||R!==Cn)&&(i.blendEquation(i.FUNC_ADD),f=Cn,R=Cn),Ye)switch(C){case jn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ya:i.blendFunc(i.ONE,i.ONE);break;case Ka:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Za:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ot("WebGLState: Invalid blending: ",C);break}else switch(C){case jn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ya:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ka:ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Za:ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ot("WebGLState: Invalid blending: ",C);break}y=null,T=null,P=null,b=null,D.set(0,0,0),B=0,m=C,M=Ye}return}Q=Q||le,Y=Y||ie,he=he||re,(le!==f||Q!==R)&&(i.blendEquationSeparate(pt[le],pt[Q]),f=le,R=Q),(ie!==y||re!==T||Y!==P||he!==b)&&(i.blendFuncSeparate(Fe[ie],Fe[re],Fe[Y],Fe[he]),y=ie,T=re,P=Y,b=he),(we.equals(D)===!1||et!==B)&&(i.blendColor(we.r,we.g,we.b,et),D.copy(we),B=et),m=C,M=!1}function A(C,le){C.side===en?de(i.CULL_FACE):J(i.CULL_FACE);let ie=C.side===Tt;le&&(ie=!ie),Be(ie),C.blending===jn&&C.transparent===!1?tt(rn):tt(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),s.setFunc(C.depthFunc),s.setTest(C.depthTest),s.setMask(C.depthWrite),a.setMask(C.colorWrite);const re=C.stencilWrite;o.setTest(re),re&&(o.setMask(C.stencilWriteMask),o.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),o.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),me(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?J(i.SAMPLE_ALPHA_TO_COVERAGE):de(i.SAMPLE_ALPHA_TO_COVERAGE)}function Be(C){v!==C&&(C?i.frontFace(i.CW):i.frontFace(i.CCW),v=C)}function ze(C){C!==No?(J(i.CULL_FACE),C!==w&&(C===qa?i.cullFace(i.BACK):C===Fo?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):de(i.CULL_FACE),w=C}function $e(C){C!==I&&(q&&i.lineWidth(C),I=C)}function me(C,le,ie){C?(J(i.POLYGON_OFFSET_FILL),(G!==le||k!==ie)&&(i.polygonOffset(le,ie),G=le,k=ie)):de(i.POLYGON_OFFSET_FILL)}function nt(C){C?J(i.SCISSOR_TEST):de(i.SCISSOR_TEST)}function Se(C){C===void 0&&(C=i.TEXTURE0+K-1),te!==C&&(i.activeTexture(C),te=C)}function De(C,le,ie){ie===void 0&&(te===null?ie=i.TEXTURE0+K-1:ie=te);let re=ae[ie];re===void 0&&(re={type:void 0,texture:void 0},ae[ie]=re),(re.type!==C||re.texture!==le)&&(te!==ie&&(i.activeTexture(ie),te=ie),i.bindTexture(C,le||X[C]),re.type=C,re.texture=le)}function E(){const C=ae[te];C!==void 0&&C.type!==void 0&&(i.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function x(){try{i.compressedTexImage2D(...arguments)}catch(C){C("WebGLState:",C)}}function N(){try{i.compressedTexImage3D(...arguments)}catch(C){C("WebGLState:",C)}}function W(){try{i.texSubImage2D(...arguments)}catch(C){C("WebGLState:",C)}}function Z(){try{i.texSubImage3D(...arguments)}catch(C){C("WebGLState:",C)}}function V(){try{i.compressedTexSubImage2D(...arguments)}catch(C){C("WebGLState:",C)}}function _e(){try{i.compressedTexSubImage3D(...arguments)}catch(C){C("WebGLState:",C)}}function oe(){try{i.texStorage2D(...arguments)}catch(C){C("WebGLState:",C)}}function Ee(){try{i.texStorage3D(...arguments)}catch(C){C("WebGLState:",C)}}function xe(){try{i.texImage2D(...arguments)}catch(C){C("WebGLState:",C)}}function j(){try{i.texImage3D(...arguments)}catch(C){C("WebGLState:",C)}}function ee(C){qe.equals(C)===!1&&(i.scissor(C.x,C.y,C.z,C.w),qe.copy(C))}function Ae(C){je.equals(C)===!1&&(i.viewport(C.x,C.y,C.z,C.w),je.copy(C))}function Te(C,le){let ie=l.get(le);ie===void 0&&(ie=new WeakMap,l.set(le,ie));let re=ie.get(C);re===void 0&&(re=i.getUniformBlockIndex(le,C.name),ie.set(C,re))}function ue(C,le){const re=l.get(le).get(C);c.get(le)!==re&&(i.uniformBlockBinding(le,re,C.__bindingPointIndex),c.set(le,re))}function Ce(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),s.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},te=null,ae={},d={},h=new WeakMap,p=[],g=null,S=!1,m=null,f=null,y=null,T=null,R=null,P=null,b=null,D=new Pe(0,0,0),B=0,M=!1,v=null,w=null,I=null,G=null,k=null,qe.set(0,0,i.canvas.width,i.canvas.height),je.set(0,0,i.canvas.width,i.canvas.height),a.reset(),s.reset(),o.reset()}return{buffers:{color:a,depth:s,stencil:o},enable:J,disable:de,bindFramebuffer:Le,drawBuffers:ge,useProgram:Oe,setBlending:tt,setMaterial:A,setFlipSided:Be,setCullFace:ze,setLineWidth:$e,setPolygonOffset:me,setScissorTest:nt,activeTexture:Se,bindTexture:De,unbindTexture:E,compressedTexImage2D:x,compressedTexImage3D:N,texImage2D:xe,texImage3D:j,updateUBOMapping:Te,uniformBlockBinding:ue,texStorage2D:oe,texStorage3D:Ee,texSubImage2D:W,texSubImage3D:Z,compressedTexSubImage2D:V,compressedTexSubImage3D:_e,scissor:ee,viewport:Ae,reset:Ce}}function Vh(i,e,t,n,r,a,s){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Xe,u=new WeakMap;let d;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,x){return p?new OffscreenCanvas(E,x):vi("canvas")}function S(E,x,N){let W=1;const Z=De(E);if((Z.width>N||Z.height>N)&&(W=N/Math.max(Z.width,Z.height)),W<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const V=Math.floor(W*Z.width),_e=Math.floor(W*Z.height);d===void 0&&(d=g(V,_e));const oe=x?g(V,_e):d;return oe.width=V,oe.height=_e,oe.getContext("2d").drawImage(E,0,0,V,_e),Ue("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+V+"x"+_e+")."),oe}else return"data"in E&&Ue("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),E;return E}function m(E){return E.generateMipmaps}function f(E){i.generateMipmap(E)}function y(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(E,x,N,W,Z=!1){if(E!==null){if(i[E]!==void 0)return i[E];Ue("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let V=x;if(x===i.RED&&(N===i.FLOAT&&(V=i.R32F),N===i.HALF_FLOAT&&(V=i.R16F),N===i.UNSIGNED_BYTE&&(V=i.R8)),x===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(V=i.R8UI),N===i.UNSIGNED_SHORT&&(V=i.R16UI),N===i.UNSIGNED_INT&&(V=i.R32UI),N===i.BYTE&&(V=i.R8I),N===i.SHORT&&(V=i.R16I),N===i.INT&&(V=i.R32I)),x===i.RG&&(N===i.FLOAT&&(V=i.RG32F),N===i.HALF_FLOAT&&(V=i.RG16F),N===i.UNSIGNED_BYTE&&(V=i.RG8)),x===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(V=i.RG8UI),N===i.UNSIGNED_SHORT&&(V=i.RG16UI),N===i.UNSIGNED_INT&&(V=i.RG32UI),N===i.BYTE&&(V=i.RG8I),N===i.SHORT&&(V=i.RG16I),N===i.INT&&(V=i.RG32I)),x===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(V=i.RGB8UI),N===i.UNSIGNED_SHORT&&(V=i.RGB16UI),N===i.UNSIGNED_INT&&(V=i.RGB32UI),N===i.BYTE&&(V=i.RGB8I),N===i.SHORT&&(V=i.RGB16I),N===i.INT&&(V=i.RGB32I)),x===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(V=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(V=i.RGBA16UI),N===i.UNSIGNED_INT&&(V=i.RGBA32UI),N===i.BYTE&&(V=i.RGBA8I),N===i.SHORT&&(V=i.RGBA16I),N===i.INT&&(V=i.RGBA32I)),x===i.RGB&&(N===i.UNSIGNED_INT_5_9_9_9_REV&&(V=i.RGB9_E5),N===i.UNSIGNED_INT_10F_11F_11F_REV&&(V=i.R11F_G11F_B10F)),x===i.RGBA){const _e=Z?er:We.getTransfer(W);N===i.FLOAT&&(V=i.RGBA32F),N===i.HALF_FLOAT&&(V=i.RGBA16F),N===i.UNSIGNED_BYTE&&(V=_e===Ze?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(V=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(V=i.RGB5_A1)}return(V===i.R16F||V===i.R32F||V===i.RG16F||V===i.RG32F||V===i.RGBA16F||V===i.RGBA32F)&&e.get("EXT_color_buffer_float"),V}function R(E,x){let N;return E?x===null||x===Un||x===xi?N=i.DEPTH24_STENCIL8:x===nn?N=i.DEPTH32F_STENCIL8:x===mi&&(N=i.DEPTH24_STENCIL8,Ue("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Un||x===xi?N=i.DEPTH_COMPONENT24:x===nn?N=i.DEPTH_COMPONENT32F:x===mi&&(N=i.DEPTH_COMPONENT16),N}function P(E,x){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==wt&&E.minFilter!==bt?Math.log2(Math.max(x.width,x.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?x.mipmaps.length:1}function b(E){const x=E.target;x.removeEventListener("dispose",b),B(x),x.isVideoTexture&&u.delete(x)}function D(E){const x=E.target;x.removeEventListener("dispose",D),v(x)}function B(E){const x=n.get(E);if(x.__webglInit===void 0)return;const N=E.source,W=h.get(N);if(W){const Z=W[x.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&M(E),Object.keys(W).length===0&&h.delete(N)}n.remove(E)}function M(E){const x=n.get(E);i.deleteTexture(x.__webglTexture);const N=E.source,W=h.get(N);delete W[x.__cacheKey],s.memory.textures--}function v(E){const x=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(x.__webglFramebuffer[W]))for(let Z=0;Z<x.__webglFramebuffer[W].length;Z++)i.deleteFramebuffer(x.__webglFramebuffer[W][Z]);else i.deleteFramebuffer(x.__webglFramebuffer[W]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[W])}else{if(Array.isArray(x.__webglFramebuffer))for(let W=0;W<x.__webglFramebuffer.length;W++)i.deleteFramebuffer(x.__webglFramebuffer[W]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let W=0;W<x.__webglColorRenderbuffer.length;W++)x.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[W]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const N=E.textures;for(let W=0,Z=N.length;W<Z;W++){const V=n.get(N[W]);V.__webglTexture&&(i.deleteTexture(V.__webglTexture),s.memory.textures--),n.remove(N[W])}n.remove(E)}let w=0;function I(){w=0}function G(){const E=w;return E>=r.maxTextures&&Ue("WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),w+=1,E}function k(E){const x=[];return x.push(E.wrapS),x.push(E.wrapT),x.push(E.wrapR||0),x.push(E.magFilter),x.push(E.minFilter),x.push(E.anisotropy),x.push(E.internalFormat),x.push(E.format),x.push(E.type),x.push(E.generateMipmaps),x.push(E.premultiplyAlpha),x.push(E.flipY),x.push(E.unpackAlignment),x.push(E.colorSpace),x.join()}function K(E,x){const N=n.get(E);if(E.isVideoTexture&&nt(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&N.__version!==E.version){const W=E.image;if(W===null)Ue("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ue("WebGLRenderer: Texture marked for update but image is incomplete");else{X(N,E,x);return}}else E.isExternalTexture&&(N.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+x)}function q(E,x){const N=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&N.__version!==E.version){X(N,E,x);return}else E.isExternalTexture&&(N.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+x)}function ne(E,x){const N=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&N.__version!==E.version){X(N,E,x);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+x)}function H(E,x){const N=n.get(E);if(E.version>0&&N.__version!==E.version){J(N,E,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+x)}const te={[Pn]:i.REPEAT,[tn]:i.CLAMP_TO_EDGE,[Jr]:i.MIRRORED_REPEAT},ae={[wt]:i.NEAREST,[fl]:i.NEAREST_MIPMAP_NEAREST,[Ci]:i.NEAREST_MIPMAP_LINEAR,[bt]:i.LINEAR,[lr]:i.LINEAR_MIPMAP_NEAREST,[Dn]:i.LINEAR_MIPMAP_LINEAR},Me={[xl]:i.NEVER,[El]:i.ALWAYS,[_l]:i.LESS,[Qs]:i.LEQUAL,[gl]:i.EQUAL,[Ml]:i.GEQUAL,[vl]:i.GREATER,[Sl]:i.NOTEQUAL};function He(E,x){if(x.type===nn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===bt||x.magFilter===lr||x.magFilter===Ci||x.magFilter===Dn||x.minFilter===bt||x.minFilter===lr||x.minFilter===Ci||x.minFilter===Dn)&&Ue("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,te[x.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,te[x.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,te[x.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,ae[x.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,ae[x.minFilter]),x.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,Me[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===wt||x.minFilter!==Ci&&x.minFilter!==Dn||x.type===nn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function qe(E,x){let N=!1;E.__webglInit===void 0&&(E.__webglInit=!0,x.addEventListener("dispose",b));const W=x.source;let Z=h.get(W);Z===void 0&&(Z={},h.set(W,Z));const V=k(x);if(V!==E.__cacheKey){Z[V]===void 0&&(Z[V]={texture:i.createTexture(),usedTimes:0},s.memory.textures++,N=!0),Z[V].usedTimes++;const _e=Z[E.__cacheKey];_e!==void 0&&(Z[E.__cacheKey].usedTimes--,_e.usedTimes===0&&M(x)),E.__cacheKey=V,E.__webglTexture=Z[V].texture}return N}function je(E,x,N){return Math.floor(Math.floor(E/N)/x)}function Qe(E,x,N,W){const V=E.updateRanges;if(V.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,N,W,x.data);else{V.sort((j,ee)=>j.start-ee.start);let _e=0;for(let j=1;j<V.length;j++){const ee=V[_e],Ae=V[j],Te=ee.start+ee.count,ue=je(Ae.start,x.width,4),Ce=je(ee.start,x.width,4);Ae.start<=Te+1&&ue===Ce&&je(Ae.start+Ae.count-1,x.width,4)===ue?ee.count=Math.max(ee.count,Ae.start+Ae.count-ee.start):(++_e,V[_e]=Ae)}V.length=_e+1;const oe=i.getParameter(i.UNPACK_ROW_LENGTH),Ee=i.getParameter(i.UNPACK_SKIP_PIXELS),xe=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let j=0,ee=V.length;j<ee;j++){const Ae=V[j],Te=Math.floor(Ae.start/4),ue=Math.ceil(Ae.count/4),Ce=Te%x.width,C=Math.floor(Te/x.width),le=ue,ie=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ce),i.pixelStorei(i.UNPACK_SKIP_ROWS,C),t.texSubImage2D(i.TEXTURE_2D,0,Ce,C,le,ie,N,W,x.data)}E.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,oe),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ee),i.pixelStorei(i.UNPACK_SKIP_ROWS,xe)}}function X(E,x,N){let W=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(W=i.TEXTURE_3D);const Z=qe(E,x),V=x.source;t.bindTexture(W,E.__webglTexture,i.TEXTURE0+N);const _e=n.get(V);if(V.version!==_e.__version||Z===!0){t.activeTexture(i.TEXTURE0+N);const oe=We.getPrimaries(We.workingColorSpace),Ee=x.colorSpace===kt?null:We.getPrimaries(x.colorSpace),xe=x.colorSpace===kt||oe===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let j=S(x.image,!1,r.maxTextureSize);j=Se(x,j);const ee=a.convert(x.format,x.colorSpace),Ae=a.convert(x.type);let Te=T(x.internalFormat,ee,Ae,x.colorSpace,x.isVideoTexture);He(W,x);let ue;const Ce=x.mipmaps,C=x.isVideoTexture!==!0,le=_e.__version===void 0||Z===!0,ie=V.dataReady,re=P(x,j);if(x.isDepthTexture)Te=R(x.format===gi,x.type),le&&(C?t.texStorage2D(i.TEXTURE_2D,1,Te,j.width,j.height):t.texImage2D(i.TEXTURE_2D,0,Te,j.width,j.height,0,ee,Ae,null));else if(x.isDataTexture)if(Ce.length>0){C&&le&&t.texStorage2D(i.TEXTURE_2D,re,Te,Ce[0].width,Ce[0].height);for(let Q=0,Y=Ce.length;Q<Y;Q++)ue=Ce[Q],C?ie&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ue.width,ue.height,ee,Ae,ue.data):t.texImage2D(i.TEXTURE_2D,Q,Te,ue.width,ue.height,0,ee,Ae,ue.data);x.generateMipmaps=!1}else C?(le&&t.texStorage2D(i.TEXTURE_2D,re,Te,j.width,j.height),ie&&Qe(x,j,ee,Ae)):t.texImage2D(i.TEXTURE_2D,0,Te,j.width,j.height,0,ee,Ae,j.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){C&&le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,re,Te,Ce[0].width,Ce[0].height,j.depth);for(let Q=0,Y=Ce.length;Q<Y;Q++)if(ue=Ce[Q],x.format!==Vt)if(ee!==null)if(C){if(ie)if(x.layerUpdates.size>0){const he=gs(ue.width,ue.height,x.format,x.type);for(const we of x.layerUpdates){const et=ue.data.subarray(we*he/ue.data.BYTES_PER_ELEMENT,(we+1)*he/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,we,ue.width,ue.height,1,ee,et)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,ue.width,ue.height,j.depth,ee,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,Te,ue.width,ue.height,j.depth,0,ue.data,0,0);else Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else C?ie&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,ue.width,ue.height,j.depth,ee,Ae,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,Te,ue.width,ue.height,j.depth,0,ee,Ae,ue.data)}else{C&&le&&t.texStorage2D(i.TEXTURE_2D,re,Te,Ce[0].width,Ce[0].height);for(let Q=0,Y=Ce.length;Q<Y;Q++)ue=Ce[Q],x.format!==Vt?ee!==null?C?ie&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,ue.width,ue.height,ee,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,Te,ue.width,ue.height,0,ue.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):C?ie&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ue.width,ue.height,ee,Ae,ue.data):t.texImage2D(i.TEXTURE_2D,Q,Te,ue.width,ue.height,0,ee,Ae,ue.data)}else if(x.isDataArrayTexture)if(C){if(le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,re,Te,j.width,j.height,j.depth),ie)if(x.layerUpdates.size>0){const Q=gs(j.width,j.height,x.format,x.type);for(const Y of x.layerUpdates){const he=j.data.subarray(Y*Q/j.data.BYTES_PER_ELEMENT,(Y+1)*Q/j.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Y,j.width,j.height,1,ee,Ae,he)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,ee,Ae,j.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Te,j.width,j.height,j.depth,0,ee,Ae,j.data);else if(x.isData3DTexture)C?(le&&t.texStorage3D(i.TEXTURE_3D,re,Te,j.width,j.height,j.depth),ie&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,ee,Ae,j.data)):t.texImage3D(i.TEXTURE_3D,0,Te,j.width,j.height,j.depth,0,ee,Ae,j.data);else if(x.isFramebufferTexture){if(le)if(C)t.texStorage2D(i.TEXTURE_2D,re,Te,j.width,j.height);else{let Q=j.width,Y=j.height;for(let he=0;he<re;he++)t.texImage2D(i.TEXTURE_2D,he,Te,Q,Y,0,ee,Ae,null),Q>>=1,Y>>=1}}else if(Ce.length>0){if(C&&le){const Q=De(Ce[0]);t.texStorage2D(i.TEXTURE_2D,re,Te,Q.width,Q.height)}for(let Q=0,Y=Ce.length;Q<Y;Q++)ue=Ce[Q],C?ie&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ee,Ae,ue):t.texImage2D(i.TEXTURE_2D,Q,Te,ee,Ae,ue);x.generateMipmaps=!1}else if(C){if(le){const Q=De(j);t.texStorage2D(i.TEXTURE_2D,re,Te,Q.width,Q.height)}ie&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ee,Ae,j)}else t.texImage2D(i.TEXTURE_2D,0,Te,ee,Ae,j);m(x)&&f(W),_e.__version=V.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function J(E,x,N){if(x.image.length!==6)return;const W=qe(E,x),Z=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+N);const V=n.get(Z);if(Z.version!==V.__version||W===!0){t.activeTexture(i.TEXTURE0+N);const _e=We.getPrimaries(We.workingColorSpace),oe=x.colorSpace===kt?null:We.getPrimaries(x.colorSpace),Ee=x.colorSpace===kt||_e===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const xe=x.isCompressedTexture||x.image[0].isCompressedTexture,j=x.image[0]&&x.image[0].isDataTexture,ee=[];for(let Y=0;Y<6;Y++)!xe&&!j?ee[Y]=S(x.image[Y],!0,r.maxCubemapSize):ee[Y]=j?x.image[Y].image:x.image[Y],ee[Y]=Se(x,ee[Y]);const Ae=ee[0],Te=a.convert(x.format,x.colorSpace),ue=a.convert(x.type),Ce=T(x.internalFormat,Te,ue,x.colorSpace),C=x.isVideoTexture!==!0,le=V.__version===void 0||W===!0,ie=Z.dataReady;let re=P(x,Ae);He(i.TEXTURE_CUBE_MAP,x);let Q;if(xe){C&&le&&t.texStorage2D(i.TEXTURE_CUBE_MAP,re,Ce,Ae.width,Ae.height);for(let Y=0;Y<6;Y++){Q=ee[Y].mipmaps;for(let he=0;he<Q.length;he++){const we=Q[he];x.format!==Vt?Te!==null?C?ie&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he,0,0,we.width,we.height,Te,we.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he,Ce,we.width,we.height,0,we.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):C?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he,0,0,we.width,we.height,Te,ue,we.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he,Ce,we.width,we.height,0,Te,ue,we.data)}}}else{if(Q=x.mipmaps,C&&le){Q.length>0&&re++;const Y=De(ee[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,re,Ce,Y.width,Y.height)}for(let Y=0;Y<6;Y++)if(j){C?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,ee[Y].width,ee[Y].height,Te,ue,ee[Y].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Ce,ee[Y].width,ee[Y].height,0,Te,ue,ee[Y].data);for(let he=0;he<Q.length;he++){const et=Q[he].image[Y].image;C?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he+1,0,0,et.width,et.height,Te,ue,et.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he+1,Ce,et.width,et.height,0,Te,ue,et.data)}}else{C?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,0,0,Te,ue,ee[Y]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0,Ce,Te,ue,ee[Y]);for(let he=0;he<Q.length;he++){const we=Q[he];C?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he+1,0,0,Te,ue,we.image[Y]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,he+1,Ce,Te,ue,we.image[Y])}}}m(x)&&f(i.TEXTURE_CUBE_MAP),V.__version=Z.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function de(E,x,N,W,Z,V){const _e=a.convert(N.format,N.colorSpace),oe=a.convert(N.type),Ee=T(N.internalFormat,_e,oe,N.colorSpace),xe=n.get(x),j=n.get(N);if(j.__renderTarget=x,!xe.__hasExternalTextures){const ee=Math.max(1,x.width>>V),Ae=Math.max(1,x.height>>V);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,V,Ee,ee,Ae,x.depth,0,_e,oe,null):t.texImage2D(Z,V,Ee,ee,Ae,0,_e,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),me(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,Z,j.__webglTexture,0,$e(x)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,Z,j.__webglTexture,V),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(E,x,N){if(i.bindRenderbuffer(i.RENDERBUFFER,E),x.depthBuffer){const W=x.depthTexture,Z=W&&W.isDepthTexture?W.type:null,V=R(x.stencilBuffer,Z),_e=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=$e(x);me(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,V,x.width,x.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,V,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,V,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,_e,i.RENDERBUFFER,E)}else{const W=x.textures;for(let Z=0;Z<W.length;Z++){const V=W[Z],_e=a.convert(V.format,V.colorSpace),oe=a.convert(V.type),Ee=T(V.internalFormat,_e,oe,V.colorSpace),xe=$e(x);N&&me(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,xe,Ee,x.width,x.height):me(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,xe,Ee,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ge(E,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const W=n.get(x.depthTexture);W.__renderTarget=x,(!W.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),K(x.depthTexture,0);const Z=W.__webglTexture,V=$e(x);if(x.depthTexture.format===_i)me(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,V):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(x.depthTexture.format===gi)me(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,V):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Oe(E){const x=n.get(E),N=E.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==E.depthTexture){const W=E.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),W){const Z=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,W.removeEventListener("dispose",Z)};W.addEventListener("dispose",Z),x.__depthDisposeCallback=Z}x.__boundDepthTexture=W}if(E.depthTexture&&!x.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");const W=E.texture.mipmaps;W&&W.length>0?ge(x.__webglFramebuffer[0],E):ge(x.__webglFramebuffer,E)}else if(N){x.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[W]),x.__webglDepthbuffer[W]===void 0)x.__webglDepthbuffer[W]=i.createRenderbuffer(),Le(x.__webglDepthbuffer[W],E,!1);else{const Z=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,V=x.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,V),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,V)}}else{const W=E.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),Le(x.__webglDepthbuffer,E,!1);else{const Z=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,V=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,V),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,V)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function pt(E,x,N){const W=n.get(E);x!==void 0&&de(W.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&Oe(E)}function Fe(E){const x=E.texture,N=n.get(E),W=n.get(x);E.addEventListener("dispose",D);const Z=E.textures,V=E.isWebGLCubeRenderTarget===!0,_e=Z.length>1;if(_e||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=x.version,s.memory.textures++),V){N.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(x.mipmaps&&x.mipmaps.length>0){N.__webglFramebuffer[oe]=[];for(let Ee=0;Ee<x.mipmaps.length;Ee++)N.__webglFramebuffer[oe][Ee]=i.createFramebuffer()}else N.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){N.__webglFramebuffer=[];for(let oe=0;oe<x.mipmaps.length;oe++)N.__webglFramebuffer[oe]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(_e)for(let oe=0,Ee=Z.length;oe<Ee;oe++){const xe=n.get(Z[oe]);xe.__webglTexture===void 0&&(xe.__webglTexture=i.createTexture(),s.memory.textures++)}if(E.samples>0&&me(E)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const Ee=Z[oe];N.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[oe]);const xe=a.convert(Ee.format,Ee.colorSpace),j=a.convert(Ee.type),ee=T(Ee.internalFormat,xe,j,Ee.colorSpace,E.isXRRenderTarget===!0),Ae=$e(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ae,ee,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,N.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),Le(N.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(V){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),He(i.TEXTURE_CUBE_MAP,x);for(let oe=0;oe<6;oe++)if(x.mipmaps&&x.mipmaps.length>0)for(let Ee=0;Ee<x.mipmaps.length;Ee++)de(N.__webglFramebuffer[oe][Ee],E,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee);else de(N.__webglFramebuffer[oe],E,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(x)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let oe=0,Ee=Z.length;oe<Ee;oe++){const xe=Z[oe],j=n.get(xe);let ee=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ee=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ee,j.__webglTexture),He(ee,xe),de(N.__webglFramebuffer,E,xe,i.COLOR_ATTACHMENT0+oe,ee,0),m(xe)&&f(ee)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(oe=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(oe,W.__webglTexture),He(oe,x),x.mipmaps&&x.mipmaps.length>0)for(let Ee=0;Ee<x.mipmaps.length;Ee++)de(N.__webglFramebuffer[Ee],E,x,i.COLOR_ATTACHMENT0,oe,Ee);else de(N.__webglFramebuffer,E,x,i.COLOR_ATTACHMENT0,oe,0);m(x)&&f(oe),t.unbindTexture()}E.depthBuffer&&Oe(E)}function tt(E){const x=E.textures;for(let N=0,W=x.length;N<W;N++){const Z=x[N];if(m(Z)){const V=y(E),_e=n.get(Z).__webglTexture;t.bindTexture(V,_e),f(V),t.unbindTexture()}}}const A=[],Be=[];function ze(E){if(E.samples>0){if(me(E)===!1){const x=E.textures,N=E.width,W=E.height;let Z=i.COLOR_BUFFER_BIT;const V=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,_e=n.get(E),oe=x.length>1;if(oe)for(let xe=0;xe<x.length;xe++)t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);const Ee=E.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let xe=0;xe<x.length;xe++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),oe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,_e.__webglColorRenderbuffer[xe]);const j=n.get(x[xe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,j,0)}i.blitFramebuffer(0,0,N,W,0,0,N,W,Z,i.NEAREST),c===!0&&(A.length=0,Be.length=0,A.push(i.COLOR_ATTACHMENT0+xe),E.depthBuffer&&E.resolveDepthBuffer===!1&&(A.push(V),Be.push(V),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Be)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,A))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let xe=0;xe<x.length;xe++){t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,_e.__webglColorRenderbuffer[xe]);const j=n.get(x[xe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,j,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const x=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function $e(E){return Math.min(r.maxSamples,E.samples)}function me(E){const x=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function nt(E){const x=s.render.frame;u.get(E)!==x&&(u.set(E,x),E.update())}function Se(E,x){const N=E.colorSpace,W=E.format,Z=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||N!==ni&&N!==kt&&(We.getTransfer(N)===Ze?(W!==Vt||Z!==sn)&&Ue("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ot("WebGLTextures: Unsupported texture color space:",N)),x}function De(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=G,this.resetTextureUnits=I,this.setTexture2D=K,this.setTexture2DArray=q,this.setTexture3D=ne,this.setTextureCube=H,this.rebindTextures=pt,this.setupRenderTarget=Fe,this.updateRenderTargetMipmap=tt,this.updateMultisampleRenderTarget=ze,this.setupDepthRenderbuffer=Oe,this.setupFrameBufferTexture=de,this.useMultisampledRTT=me}function Gh(i,e){function t(n,r=kt){let a;const s=We.getTransfer(r);if(n===sn)return i.UNSIGNED_BYTE;if(n===wa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Pa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ys)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ks)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Xs)return i.BYTE;if(n===qs)return i.SHORT;if(n===mi)return i.UNSIGNED_SHORT;if(n===Ca)return i.INT;if(n===Un)return i.UNSIGNED_INT;if(n===nn)return i.FLOAT;if(n===ri)return i.HALF_FLOAT;if(n===Zs)return i.ALPHA;if(n===Js)return i.RGB;if(n===Vt)return i.RGBA;if(n===_i)return i.DEPTH_COMPONENT;if(n===gi)return i.DEPTH_STENCIL;if(n===js)return i.RED;if(n===Da)return i.RED_INTEGER;if(n===La)return i.RG;if(n===Ua)return i.RG_INTEGER;if(n===Ia)return i.RGBA_INTEGER;if(n===Zi||n===Ji||n===ji||n===Qi)if(s===Ze)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(n===Zi)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ji)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ji)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Qi)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(n===Zi)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ji)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ji)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Qi)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===jr||n===Qr||n===$r||n===ea)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(n===jr)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Qr)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===$r)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ea)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ta||n===na||n===ia)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(n===ta||n===na)return s===Ze?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(n===ia)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ra||n===aa||n===sa||n===oa||n===la||n===ca||n===ua||n===fa||n===da||n===ha||n===pa||n===ma||n===xa||n===_a)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(n===ra)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===aa)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===sa)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===oa)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===la)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ca)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ua)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===fa)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===da)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ha)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===pa)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ma)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===xa)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_a)return s===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ga||n===va||n===Sa)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(n===ga)return s===Ze?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===va)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Sa)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ma||n===Ea||n===ba||n===Ta)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(n===Ma)return a.COMPRESSED_RED_RGTC1_EXT;if(n===Ea)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ba)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ta)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===xi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Hh=`
void main() {
...
void main() {
...
}`;class Wh{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new fo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new qt({vertexShader:Hh,fragmentShader:kh,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ln(new yi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Xh extends ai{constructor(e,t){super();const n=this;let r=null,a=1,s=null,o="local-floor",c=1,l=null,u=null,d=null,h=null,p=null,g=null;const S=typeof XRWebGLBinding<"u",m=new Wh,f={},y=t.getContextAttributes();let T=null,R=null;const P=[],b=[],D=new Xe;let B=null;const M=new Bt;M.viewport=new lt;const v=new Bt;v.viewport=new lt;const w=[M,v],I=new lc;let G=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let J=P[X];return J===void 0&&(J=new Dr,P[X]=J),J.getTargetRaySpace()},this.getControllerGrip=function(X){let J=P[X];return J===void 0&&(J=new Dr,P[X]=J),J.getGripSpace()},this.getHand=function(X){let J=P[X];return J===void 0&&(J=new Dr,P[X]=J),J.getHandSpace()};function K(X){const J=b.indexOf(X.inputSource);if(J===-1)return;const de=P[J];de!==void 0&&(de.update(X.inputSource,X.frame,l||s),de.dispatchEvent({type:X.type,data:X.inputSource}))}function q(){r.removeEventListener("select",K),r.removeEventListener("selectstart",K),r.removeEventListener("selectend",K),r.removeEventListener("squeeze",K),r.removeEventListener("squeezestart",K),r.removeEventListener("squeezeend",K),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",ne);for(let X=0;X<P.length;X++){const J=b[X];J!==null&&(b[X]=null,P[X].disconnect(J))}G=null,k=null,m.reset();for(const X in f)delete f[X];e.setRenderTarget(T),p=null,h=null,d=null,r=null,R=null,Qe.stop(),n.isPresenting=!1,e.setPixelRatio(B),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){a=X,n.isPresenting===!0&&Ue("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&Ue("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||s},this.setReferenceSpace=function(X){l=X},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return d===null&&S&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(T=e.getRenderTarget(),r.addEventListener("select",K),r.addEventListener("selectstart",K),r.addEventListener("selectend",K),r.addEventListener("squeeze",K),r.addEventListener("squeezestart",K),r.addEventListener("squeezeend",K),r.addEventListener("end",q),r.addEventListener("inputsourceschange",ne),y.xrCompatible!==!0&&await t.makeXRCompatible(),B=e.getPixelRatio(),e.getSize(D),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let de=null,Le=null,ge=null;y.depth&&(ge=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,de=y.stencil?gi:_i,Le=y.stencil?xi:Un);const Oe={colorFormat:t.RGBA8,depthFormat:ge,scaleFactor:a};d=this.getBinding(),h=d.createProjectionLayer(Oe),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),R=new In(h.textureWidth,h.textureHeight,{format:Vt,type:sn,depthTexture:new uo(h.textureWidth,h.textureHeight,Le,void 0,void 0,void 0,void 0,void 0,void 0,de),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const de={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:a};p=new XRWebGLLayer(r,t,de),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),R=new In(p.framebufferWidth,p.framebufferHeight,{format:Vt,type:sn,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}R.isXRRenderTarget=!0,this.setFoveation(c),l=null,s=await r.requestReferenceSpace(o),Qe.setContext(r),Qe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function ne(X){for(let J=0;J<X.removed.length;J++){const de=X.removed[J],Le=b.indexOf(de);Le>=0&&(b[Le]=null,P[Le].disconnect(de))}for(let J=0;J<X.added.length;J++){const de=X.added[J];let Le=b.indexOf(de);if(Le===-1){for(let Oe=0;Oe<P.length;Oe++)if(Oe>=b.length){b.push(de),Le=Oe;break}else if(b[Oe]===null){b[Oe]=de,Le=Oe;break}if(Le===-1)break}const ge=P[Le];ge&&ge.connect(de)}}const H=new z,te=new z;function ae(X,J,de){H.setFromMatrixPosition(J.matrixWorld),te.setFromMatrixPosition(de.matrixWorld);const Le=H.distanceTo(te),ge=J.projectionMatrix.elements,Oe=de.projectionMatrix.elements,pt=ge[14]/(ge[10]-1),Fe=ge[14]/(ge[10]+1),tt=(ge[9]+1)/ge[5],A=(ge[9]-1)/ge[5],Be=(ge[8]-1)/ge[0],ze=(Oe[8]+1)/Oe[0],$e=pt*Be,me=pt*ze,nt=Le/(-Be+ze),Se=nt*-Be;if(J.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(Se),X.translateZ(nt),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),ge[10]===-1)X.projectionMatrix.copy(J.projectionMatrix),X.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const De=pt+nt,E=Fe+nt,x=$e-Se,N=me+(Le-Se),W=tt*Fe/E*De,Z=A*Fe/E*De;X.projectionMatrix.makePerspective(x,N,W,Z,De,E),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function Me(X,J){J===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(J.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;let J=X.near,de=X.far;m.texture!==null&&(m.depthNear>0&&(J=m.depthNear),m.depthFar>0&&(de=m.depthFar)),I.near=v.near=M.near=J,I.far=v.far=M.far=de,(G!==I.near||k!==I.far)&&(r.updateRenderState({depthNear:I.near,depthFar:I.far}),G=I.near,k=I.far),I.layers.mask=X.layers.mask|6,M.layers.mask=I.layers.mask&3,v.layers.mask=I.layers.mask&5;const Le=X.parent,ge=I.cameras;Me(I,Le);for(let Oe=0;Oe<ge.length;Oe++)Me(ge[Oe],Le);ge.length===2?ae(I,M,v):I.projectionMatrix.copy(M.projectionMatrix),He(X,I,Le)};function He(X,J,de){de===null?X.matrix.copy(J.matrixWorld):(X.matrix.copy(de.matrixWorld),X.matrix.invert(),X.matrix.multiply(J.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(J.projectionMatrix),X.projectionMatrixInverse.copy(J.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=ya*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(h===null&&p===null))return c},this.setFoveation=function(X){c=X,h!==null&&(h.fixedFoveation=X),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=X)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(I)},this.getCameraTexture=function(X){return f[X]};let qe=null;function je(X,J){if(u=J.getViewerPose(l||s),g=J,u!==null){const de=u.views;p!==null&&(e.setRenderTargetFramebuffer(R,p.framebuffer),e.setRenderTarget(R));let Le=!1;de.length!==I.cameras.length&&(I.cameras.length=0,Le=!0);for(let Fe=0;Fe<de.length;Fe++){const tt=de[Fe];let A=null;if(p!==null)A=p.getViewport(tt);else{const ze=d.getViewSubImage(h,tt);A=ze.viewport,Fe===0&&(e.setRenderTargetTextures(R,ze.colorTexture,ze.depthStencilTexture),e.setRenderTarget(R))}let Be=w[Fe];Be===void 0&&(Be=new Bt,Be.layers.enable(Fe),Be.viewport=new lt,w[Fe]=Be),Be.matrix.fromArray(tt.transform.matrix),Be.matrix.decompose(Be.position,Be.quaternion,Be.scale),Be.projectionMatrix.fromArray(tt.projectionMatrix),Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(),Be.viewport.set(A.x,A.y,A.width,A.height),Fe===0&&(I.matrix.copy(Be.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Le===!0&&I.cameras.push(Be)}const ge=r.enabledFeatures;if(ge&&ge.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&S){d=n.getBinding();const Fe=d.getDepthInformation(de[0]);Fe&&Fe.isValid&&Fe.texture&&m.init(Fe,r.renderState)}if(ge&&ge.includes("camera-access")&&S){e.state.unbindTexture(),d=n.getBinding();for(let Fe=0;Fe<de.length;Fe++){const tt=de[Fe].camera;if(tt){let A=f[tt];A||(A=new fo,f[tt]=A);const Be=d.getCameraImage(tt);A.sourceTexture=Be}}}}for(let de=0;de<P.length;de++){const Le=b[de],ge=P[de];Le!==null&&ge!==void 0&&ge.update(Le,J,l||s)}qe&&qe(X,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),g=null}const Qe=new po;Qe.setAnimationLoop(je),this.setAnimationLoop=function(X){qe=X},this.dispose=function(){}}}const An=new on,qh=new ut;function Yh(i,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,so(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,y,T,R){f.isMeshBasicMaterial||f.isMeshLambertMaterial?a(m,f):f.isMeshToonMaterial?(a(m,f),d(m,f)):f.isMeshPhongMaterial?(a(m,f),u(m,f)):f.isMeshStandardMaterial?(a(m,f),h(m,f),f.isMeshPhysicalMaterial&&p(m,f,R)):f.isMeshMatcapMaterial?(a(m,f),g(m,f)):f.isMeshDepthMaterial?a(m,f):f.isMeshDistanceMaterial?(a(m,f),S(m,f)):f.isMeshNormalMaterial?a(m,f):f.isLineBasicMaterial?(s(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?c(m,f,y,T):f.isSpriteMaterial?l(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Tt&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Tt&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const y=e.get(f),T=y.envMap,R=y.envMapRotation;T&&(m.envMap.value=T,An.copy(R),An.x*=-1,An.y*=-1,An.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(An.y*=-1,An.z*=-1),m.envMapRotation.value.setFromMatrix4(qh.makeRotationFromEuler(An)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function s(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function c(m,f,y,T){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*y,m.scale.value=T*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function l(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function d(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function h(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,y){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Tt&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function S(m,f){const y=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Kh(i,e,t,n){let r={},a={},s=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,T){const R=T.program;n.uniformBlockBinding(y,R)}function l(y,T){let R=r[y.id];R===void 0&&(g(y),R=u(y),r[y.id]=R,y.addEventListener("dispose",m));const P=T.program;n.updateUBOMapping(y,P);const b=e.render.frame;a[y.id]!==b&&(h(y),a[y.id]=b)}function u(y){const T=d();y.__bindingPointIndex=T;const R=i.createBuffer(),P=y.__size,b=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,R),i.bufferData(i.UNIFORM_BUFFER,P,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,R),R}function d(){for(let y=0;y<o;y++)if(s.indexOf(y)===-1)return s.push(y),y;return ot("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){const T=r[y.id],R=y.uniforms,P=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let b=0,D=R.length;b<D;b++){const B=Array.isArray(R[b])?R[b]:[R[b]];for(let M=0,v=B.length;M<v;M++){const w=B[M];if(p(w,b,M,P)===!0){const I=w.__offset,G=Array.isArray(w.value)?w.value:[w.value];let k=0;for(let K=0;K<G.length;K++){const q=G[K],ne=S(q);typeof q=="number"||typeof q=="boolean"?(w.__data[0]=q,i.bufferSubData(i.UNIFORM_BUFFER,I+k,w.__data)):q.isMatrix3?(w.__data[0]=q.elements[0],w.__data[1]=q.elements[1],w.__data[2]=q.elements[2],w.__data[3]=0,w.__data[4]=q.elements[3],w.__data[5]=q.elements[4],w.__data[6]=q.elements[5],w.__data[7]=0,w.__data[8]=q.elements[6],w.__data[9]=q.elements[7],w.__data[10]=q.elements[8],w.__data[11]=0):(q.toArray(w.__data,k),k+=ne.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,I,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(y,T,R,P){const b=y.value,D=T+"_"+R;if(P[D]===void 0)return typeof b=="number"||typeof b=="boolean"?P[D]=b:P[D]=b.clone(),!0;{const B=P[D];if(typeof b=="number"||typeof b=="boolean"){if(B!==b)return P[D]=b,!0}else if(B.equals(b)===!1)return B.copy(b),!0}return!1}function g(y){const T=y.uniforms;let R=0;const P=16;for(let D=0,B=T.length;D<B;D++){const M=Array.isArray(T[D])?T[D]:[T[D]];for(let v=0,w=M.length;v<w;v++){const I=M[v],G=Array.isArray(I.value)?I.value:[I.value];for(let k=0,K=G.length;k<K;k++){const q=G[k],ne=S(q),H=R%P,te=H%ne.boundary,ae=H+te;R+=te,ae!==0&&P-ae<ne.storage&&(R+=P-ae),I.__data=new Float32Array(ne.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=R,R+=ne.storage}}}const b=R%P;return b>0&&(R+=P-b),y.__size=R,y.__cache={},this}function S(y){const T={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(T.boundary=4,T.storage=4):y.isVector2?(T.boundary=8,T.storage=8):y.isVector3||y.isColor?(T.boundary=16,T.storage=12):y.isVector4?(T.boundary=16,T.storage=16):y.isMatrix3?(T.boundary=48,T.storage=48):y.isMatrix4?(T.boundary=64,T.storage=64):y.isTexture?Ue("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ue("WebGLRenderer: Unsupported uniform value type.",y),T}function m(y){const T=y.target;T.removeEventListener("dispose",m);const R=s.indexOf(T.__bindingPointIndex);s.splice(R,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete a[T.id]}function f(){for(const y in r)i.deleteBuffer(r[y]);s=[],r={},a={}}return{bind:c,update:l,dispose:f}}const Zh=new Uint16Array([11481,15204,11534,15171,11808,15015,12385,14843,12894,14716,13396,14600,13693,14483,13976,14366,14237,14171,14405,13961,14511,13770,14605,13598,14687,13444,14760,13305,14822,13066,14876,12857,14923,12675,14963,12517,14997,12379,15025,12230,15049,12023,15070,11843,15086,11687,15100,11551,15111,11433,15120,11330,15127,11217,15132,11060,15135,10922,15138,10801,15139,10695,15139,10600,13012,14923,13020,14917,13064,14886,13176,14800,13349,14666,13513,14526,13724,14398,13960,14230,14200,14020,14383,13827,14488,13651,14583,13491,14667,13348,14740,13132,14803,12908,14856,12713,14901,12542,14938,12394,14968,12241,14992,12017,15010,11822,15024,11654,15034,11507,15041,11380,15044,11269,15044,11081,15042,10913,15037,10764,15031,10635,15023,10520,15014,10419,15003,10330,13657,14676,13658,14673,13670,14660,13698,14622,13750,14547,13834,14442,13956,14317,14112,14093,14291,13889,14407,13704,14499,13538,14586,13389,14664,13201,14733,12966,14792,12758,14842,12577,14882,12418,14915,12272,14940,12033,14959,11826,14972,11646,14980,11490,14983,11355,14983,11212,14979,11008,14971,10830,14961,10675,14950,10540,14936,10420,14923,10315,14909,10204,14894,10041,14089,14460,14090,14459,14096,14452,14112,14431,14141,14388,14186,14305,14252,14130,14341,13941,14399,13756,14467,13585,14539,13430,14610,13272,14677,13026,14737,12808,14790,12617,14833,12449,14869,12303,14896,12065,14916,11845,14929,11655,14937,11490,14939,11347,14936,11184,14930,10970,14921,10783,14912,10621,14900,10480,14885,10356,14867,10247,14848,10062,14827,9894,14805,9745,14400,14208,14400,14206,14402,14198,14406,14174,14415,14122,14427,14035,14444,13913,14469,13767,14504,13613,14548,13463,14598,13324,14651,13082,14704,12858,14752,12658,14795,12483,14831,12330,14860,12106,14881,11875,14895,11675,14903,11501,14905,11351,14903,11178,14900,10953,14892,10757,14880,10589,14865,10442,14847,10313,14827,10162,14805,9965,14782,9792,14757,9642,14731,9507,14562,13883,14562,13883,14563,13877,14566,13862,14570,13830,14576,13773,14584,13689,14595,13582,14613,13461,14637,13336,14668,13120,14704,12897,14741,12695,14776,12516,14808,12358,14835,12150,14856,11910,14870,11701,14878,11519,14882,11361,14884,11187,14880,10951,14871,10748,14858,10572,14842,10418,14823,10286,14801,10099,14777,9897,14751,9722,14725,9567,14696,9430,14666,9309,14702,13604,14702,13604,14702,13600,14703,13591,14705,13570,14707,13533,14709,13477,14712,13400,14718,13305,14727,13106,14743,12907,14762,12716,14784,12539,14807,12380,14827,12190,14844,11943,14855,11727,14863,11539,14870,11376,14871,11204,14868,10960,14858,10748,14845,10565,14829,10406,14809,10269,14786,10058,14761,9852,14734,9671,14705,9512,14674,9374,14641,9253,14608,9076,14821,13366,14821,13365,14821,13364,14821,13358,14821,13344,14821,13320,14819,13252,14817,13145,14815,13011,14814,12858,14817,12698,14823,12539,14832,12389,14841,12214,14850,11968,14856,11750,14861,11558,14866,11390,14867,11226,14862,10972,14853,10754,14840,10565,14823,10401,14803,10259,14780,10032,14754,9820,14725,9635,14694,9473,14661,9333,14627,9203,14593,8988,14557,8798,14923,13014,14922,13014,14922,13012,14922,13004,14920,12987,14919,12957,14915,12907,14909,12834,14902,12738,14894,12623,14888,12498,14883,12370,14880,12203,14878,11970,14875,11759,14873,11569,14874,11401,14872,11243,14865,10986,14855,10762,14842,10568,14825,10401,14804,10255,14781,10017,14754,9799,14725,9611,14692,9445,14658,9301,14623,9139,14587,8920,14548,8729,14509,8562,15008,12672,15008,12672,15008,12671,15007,12667,15005,12656,15001,12637,14997,12605,14989,12556,14978,12490,14966,12407,14953,12313,14940,12136,14927,11934,14914,11742,14903,11563,14896,11401,14889,11247,14879,10992,14866,10767,14851,10570,14833,10400,14812,10252,14789,10007,14761,9784,14731,9592,14698,9424,14663,9279,14627,9088,14588,8868,14548,8676,14508,8508,14467,8360,15080,12386,15080,12386,15079,12385,15078,12383,15076,12378,15072,12367,15066,12347,15057,12315,15045,12253,15030,12138,15012,11998,14993,11845,14972,11685,14951,11530,14935,11383,14920,11228,14904,10981,14887,10762,14870,10567,14850,10397,14827,10248,14803,9997,14774,9771,14743,9578,14710,9407,14674,9259,14637,9048,14596,8826,14555,8632,14514,8464,14471,8317,14427,8182,15139,12008,15139,12008,15138,12008,15137,12007,15135,12003,15130,11990,15124,11969,15115,11929,15102,11872,15086,11794,15064,11693,15041,11581,15013,11459,14987,11336,14966,11170,14944,10944,14921,10738,14898,10552,14875,10387,14850,10239,14824,9983,14794,9758,14762,9563,14728,9392,14692,9244,14653,9014,14611,8791,14569,8597,14526,8427,14481,8281,14436,8110,14391,7885,15188,11617,15188,11617,15187,11617,15186,11618,15183,11617,15179,11612,15173,11601,15163,11581,15150,11546,15133,11495,15110,11427,15083,11346,15051,11246,15024,11057,14996,10868,14967,10687,14938,10517,14911,10362,14882,10206,14853,9956,14821,9737,14787,9543,14752,9375,14715,9228,14675,8980,14632,8760,14589,8565,14544,8395,14498,8248,14451,8049,14404,7824,14357,7630,15228,11298,15228,11298,15227,11299,15226,11301,15223,11303,15219,11302,15213,11299,15204,11290,15191,11271,15174,11217,15150,11129,15119,11015,15087,10886,15057,10744,15024,10599,14990,10455,14957,10318,14924,10143,14891,9911,14856,9701,14820,9516,14782,9352,14744,9200,14703,8946,14659,8725,14615,8533,14568,8366,14521,8220,14472,7992,14423,7770,14374,7578,14315,7408,15260,10819,15260,10819,15259,10822,15258,10826,15256,10832,15251,10836,15246,10841,15237,10838,15225,10821,15207,10788,15183,10734,15151,10660,15120,10571,15087,10469,15049,10359,15012,10249,14974,10041,14937,9837,14900,9647,14860,9475,14820,9320,14779,9147,14736,8902,14691,8688,14646,8499,14598,8335,14549,8189,14499,7940,14448,7720,14397,7529,14347,7363,14256,7218,15285,10410,15285,10411,15285,10413,15284,10418,15282,10425,15278,10434,15272,10442,15264,10449,15252,10445,15235,10433,15210,10403,15179,10358,15149,10301,15113,10218,15073,10059,15033,9894,14991,9726,14951,9565,14909,9413,14865,9273,14822,9073,14777,8845,14730,8641,14682,8459,14633,8300,14583,8129,14531,7883,14479,7670,14426,7482,14373,7321,14305,7176,14201,6939,15305,9939,15305,9940,15305,9945,15304,9955,15302,9967,15298,9989,15293,10010,15286,10033,15274,10044,15258,10045,15233,10022,15205,9975,15174,9903,15136,9808,15095,9697,15053,9578,15009,9451,14965,9327,14918,9198,14871,8973,14825,8766,14775,8579,14725,8408,14675,8259,14622,8058,14569,7821,14515,7615,14460,7435,14405,7276,14350,7108,14256,6866,14149,6653,15321,9444,15321,9445,15321,9448,15320,9458,15317,9470,15314,9490,15310,9515,15302,9540,15292,9562,15276,9579,15251,9577,15226,9559,15195,9519,15156,9463,15116,9389,15071,9304,15025,9208,14978,9023,14927,8838,14878,8661,14827,8496,14774,8344,14722,8206,14667,7973,14612,7749,14556,7555,14499,7382,14443,7229,14385,7025,14322,6791,14210,6588,14100,6409,15333,8920,15333,8921,15332,8927,15332,8943,15329,8965,15326,9002,15322,9048,15316,9106,15307,9162,15291,9204,15267,9221,15244,9221,15212,9196,15175,9134,15133,9043,15088,8930,15040,8801,14990,8665,14938,8526,14886,8391,14830,8261,14775,8087,14719,7866,14661,7664,14603,7482,14544,7322,14485,7178,14426,6936,14367,6713,14281,6517,14166,6348,14054,6198,15341,8360,15341,8361,15341,8366,15341,8379,15339,8399,15336,8431,15332,8473,15326,8527,15318,8585,15302,8632,15281,8670,15258,8690,15227,8690,15191,8664,15149,8612,15104,8543,15055,8456,15001,8360,14948,8259,14892,8122,14834,7923,14776,7734,14716,7558,14656,7397,14595,7250,14534,7070,14472,6835,14410,6628,14350,6443,14243,6283,14125,6135,14010,5889,15348,7715,15348,7717,15348,7725,15347,7745,15345,7780,15343,7836,15339,7905,15334,8e3,15326,8103,15310,8193,15293,8239,15270,8270,15240,8287,15204,8283,15163,8260,15118,8223,15067,8143,15014,8014,14958,7873,14899,7723,14839,7573,14778,7430,14715,7293,14652,7164,14588,6931,14524,6720,14460,6531,14396,6362,14330,6210,14207,6015,14086,5781,13969,5576,15352,7114,15352,7116,15352,7128,15352,7159,15350,7195,15348,7237,15345,7299,15340,7374,15332,7457,15317,7544,15301,7633,15280,7703,15251,7754,15216,7775,15176,7767,15131,7733,15079,7670,15026,7588,14967,7492,14906,7387,14844,7278,14779,7171,14714,6965,14648,6770,14581,6587,14515,6420,14448,6269,14382,6123,14299,5881,14172,5665,14049,5477,13929,5310,15355,6329,15355,6330,15355,6339,15355,6362,15353,6410,15351,6472,15349,6572,15344,6688,15337,6835,15323,6985,15309,7142,15287,7220,15260,7277,15226,7310,15188,7326,15142,7318,15090,7285,15036,7239,14976,7177,14914,7045,14849,6892,14782,6736,14714,6581,14645,6433,14576,6293,14506,6164,14438,5946,14369,5733,14270,5540,14140,5369,14014,5216,13892,5043,15357,5483,15357,5484,15357,5496,15357,5528,15356,5597,15354,5692,15351,5835,15347,6011,15339,6195,15328,6317,15314,6446,15293,6566,15268,6668,15235,6746,15197,6796,15152,6811,15101,6790,15046,6748,14985,6673,14921,6583,14854,6479,14785,6371,14714,6259,14643,6149,14571,5946,14499,5750,14428,5567,14358,5401,14242,5250,14109,5111,13980,4870,13856,4657,15359,4555,15359,4557,15358,4573,15358,4633,15357,4715,15355,4841,15353,5061,15349,5216,15342,5391,15331,5577,15318,5770,15299,5967,15274,6150,15243,6223,15206,6280,15161,6310,15111,6317,15055,6300,14994,6262,14928,6208,14860,6141,14788,5994,14715,5838,14641,5684,14566,5529,14492,5384,14418,5247,14346,5121,14216,4892,14079,4682,13948,4496,13822,4330,15359,3498,15359,3501,15359,3520,15359,3598,15358,3719,15356,3860,15355,4137,15351,4305,15344,4563,15334,4809,15321,5116,15303,5273,15280,5418,15250,5547,15214,5653,15170,5722,15120,5761,15064,5763,15002,5733,14935,5673,14865,5597,14792,5504,14716,5400,14640,5294,14563,5185,14486,5041,14410,4841,14335,4655,14191,4482,14051,4325,13918,4183,13790,4012,15360,2282,15360,2285,15360,2306,15360,2401,15359,2547,15357,2748,15355,3103,15352,3349,15345,3675,15336,4020,15324,4272,15307,4496,15285,4716,15255,4908,15220,5086,15178,5170,15128,5214,15072,5234,15010,5231,14943,5206,14871,5166,14796,5102,14718,4971,14639,4833,14559,4687,14480,4541,14402,4401,14315,4268,14167,4142,14025,3958,13888,3747,13759,3556,15360,923,15360,925,15360,946,15360,1052,15359,1214,15357,1494,15356,1892,15352,2274,15346,2663,15338,3099,15326,3393,15309,3679,15288,3980,15260,4183,15226,4325,15185,4437,15136,4517,15080,4570,15018,4591,14950,4581,14877,4545,14800,4485,14720,4411,14638,4325,14556,4231,14475,4136,14395,3988,14297,3803,14145,3628,13999,3465,13861,3314,13729,3177,15360,263,15360,264,15360,272,15360,325,15359,407,15358,548,15356,780,15352,1144,15347,1580,15339,2099,15328,2425,15312,2795,15292,3133,15264,3329,15232,3517,15191,3689,15143,3819,15088,3923,15025,3978,14956,3999,14882,3979,14804,3931,14722,3855,14639,3756,14554,3645,14470,3529,14388,3409,14279,3289,14124,3173,13975,3055,13834,2848,13701,2658,15360,49,15360,49,15360,52,15360,75,15359,111,15358,201,15356,283,15353,519,15348,726,15340,1045,15329,1415,15314,1795,15295,2173,15269,2410,15237,2649,15197,2866,15150,3054,15095,3140,15032,3196,14963,3228,14888,3236,14808,3224,14725,3191,14639,3146,14553,3088,14466,2976,14382,2836,14262,2692,14103,2549,13952,2409,13808,2278,13674,2154,15360,4,15360,4,15360,4,15360,13,15359,33,15358,59,15357,112,15353,199,15348,302,15341,456,15331,628,15316,827,15297,1082,15272,1332,15241,1601,15202,1851,15156,2069,15101,2172,15039,2256,14970,2314,14894,2348,14813,2358,14728,2344,14640,2311,14551,2263,14463,2203,14376,2133,14247,2059,14084,1915,13930,1761,13784,1609,13648,1464,15360,0,15360,0,15360,0,15360,3,15359,18,15358,26,15357,53,15354,80,15348,97,15341,165,15332,238,15318,326,15299,427,15275,529,15245,654,15207,771,15161,885,15108,994,15046,1089,14976,1170,14900,1229,14817,1266,14731,1284,14641,1282,14550,1260,14460,1223,14370,1174,14232,1116,14066,1050,13909,981,13761,910,13623,839]);let Qt=null;function Jh(){return Qt===null&&(Qt=new Ql(Zh,32,32,La,ri),Qt.minFilter=bt,Qt.magFilter=bt,Qt.wrapS=tn,Qt.wrapT=tn,Qt.generateMipmaps=!1,Qt.needsUpdate=!0),Qt}class jh{constructor(e={}){const{canvas:t=bl(),context:n=null,depth:r=!0,stencil:a=!1,alpha:s=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=s;const g=new Set([Ia,Ua,Da]),S=new Set([sn,Un,mi,xi,wa,Pa]),m=new Uint32Array(4),f=new Int32Array(4);let y=null,T=null;const R=[],P=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=xn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const b=this;let D=!1;this._outputColorSpace=Ut;let B=0,M=0,v=null,w=-1,I=null;const G=new lt,k=new lt;let K=null;const q=new Pe(0);let ne=0,H=t.width,te=t.height,ae=1,Me=null,He=null;const qe=new lt(0,0,H,te),je=new lt(0,0,H,te);let Qe=!1;const X=new co;let J=!1,de=!1;const Le=new ut,ge=new z,Oe=new lt,pt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Fe=!1;function tt(){return v===null?ae:1}let A=n;function Be(_,L){return t.getContext(_,L)}try{const _={alpha:!0,depth:r,stencil:a,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ra}`),t.addEventListener("webglcontextlost",Q,!1),t.addEventListener("webglcontextrestored",Y,!1),t.addEventListener("webglcontextcreationerror",he,!1),A===null){const L="webgl2";if(A=Be(L,_),A===null)throw Be(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(_){throw _("WebGLRenderer: "+_.message),_}let ze,$e,me,nt,Se,De,E,x,N,W,Z,V,_e,oe,Ee,xe,j,ee,Ae,Te,ue,Ce,C,le;function ie(){ze=new ad(A),ze.init(),Ce=new Gh(A,ze),$e=new Jf(A,ze,e,Ce),me=new zh(A,ze),$e.reversedDepthBuffer&&h&&me.buffers.depth.setReversed(!0),nt=new ld(A),Se=new Ah,De=new Vh(A,ze,me,Se,$e,Ce,nt),E=new Qf(b),x=new rd(b),N=new fc(A),C=new Kf(A,N),W=new sd(A,N,nt,C),Z=new ud(A,W,N,nt),Ae=new cd(A,$e,De),xe=new jf(Se),V=new yh(b,E,x,ze,$e,C,xe),_e=new Yh(b,Se),oe=new Ch,Ee=new Ih(ze),ee=new Yf(b,E,x,me,Z,p,c),j=new Oh(b,Z,$e),le=new Kh(A,nt,$e,me),Te=new Zf(A,ze,nt),ue=new od(A,ze,nt),nt.programs=V.programs,b.capabilities=$e,b.extensions=ze,b.properties=Se,b.renderLists=oe,b.shadowMap=j,b.state=me,b.info=nt}ie();const re=new Xh(b,A);this.xr=re,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const _=ze.get("WEBGL_lose_context");_&&_.loseContext()},this.forceContextRestore=function(){const _=ze.get("WEBGL_lose_context");_&&_.restoreContext()},this.getPixelRatio=function(){return ae},this.setPixelRatio=function(_){_!==void 0&&(ae=_,this.setSize(H,te,!1))},this.getSize=function(_){return _.set(H,te)},this.setSize=function(_,L,F=!0){if(re.isPresenting){Ue("WebGLRenderer: Can't change size while VR device is presenting.");return}H=_,te=L,t.width=Math.floor(_*ae),t.height=Math.floor(L*ae),F===!0&&(t.style.width=_+"px",t.style.height=L+"px"),this.setViewport(0,0,_,L)},this.getDrawingBufferSize=function(_){return _.set(H*ae,te*ae).floor()},this.setDrawingBufferSize=function(_,L,F){H=_,te=L,ae=F,t.width=Math.floor(_*F),t.height=Math.floor(L*F),this.setViewport(0,0,_,L)},this.getCurrentViewport=function(_){return _.copy(G)},this.getViewport=function(_){return _.copy(qe)},this.setViewport=function(_,L,F,O){_.isVector4?qe.set(_.x,_.y,_.z,_.w):qe.set(_,L,F,O),me.viewport(G.copy(qe).multiplyScalar(ae).round())},this.getScissor=function(_){return _.copy(je)},this.setScissor=function(_,L,F,O){_.isVector4?je.set(_.x,_.y,_.z,_.w):je.set(_,L,F,O),me.scissor(k.copy(je).multiplyScalar(ae).round())},this.getScissorTest=function(){return Qe},this.setScissorTest=function(_){me.setScissorTest(Qe=_)},this.setOpaqueSort=function(_){Me=_},this.setTransparentSort=function(_){He=_},this.getClearColor=function(_){return _.copy(ee.getClearColor())},this.setClearColor=function(){ee.setClearColor(...arguments)},this.getClearAlpha=function(){return ee.getClearAlpha()},this.setClearAlpha=function(){ee.setClearAlpha(...arguments)},this.clear=function(_=!0,L=!0,F=!0){let O=0;if(_){let U=!1;if(v!==null){const $=v.texture.format;U=g.has($)}if(U){const $=v.texture.type,ce=S.has($),pe=ee.getClearColor(),fe=ee.getClearAlpha(),ye=pe.r,Re=pe.g,ve=pe.b;ce?(m[0]=ye,m[1]=Re,m[2]=ve,m[3]=fe,A.clearBufferuiv(A.COLOR,0,m)):(f[0]=ye,f[1]=Re,f[2]=ve,f[3]=fe,A.clearBufferiv(A.COLOR,0,f))}else O|=A.COLOR_BUFFER_BIT}L&&(O|=A.DEPTH_BUFFER_BIT),F&&(O|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Q,!1),t.removeEventListener("webglcontextrestored",Y,!1),t.removeEventListener("webglcontextcreationerror",he,!1),ee.dispose(),oe.dispose(),Ee.dispose(),Se.dispose(),E.dispose(),x.dispose(),Z.dispose(),C.dispose(),le.dispose(),V.dispose(),re.dispose(),re.removeEventListener("sessionstart",Ba),re.removeEventListener("sessionend",za),vn.stop()};function Q(_){_.preventDefault(),ts("WebGLRenderer: Context Lost."),D=!0}function Y(){ts("WebGLRenderer: Context Restored."),D=!1;const _=nt.autoReset,L=j.enabled,F=j.autoUpdate,O=j.needsUpdate,U=j.type;ie(),nt.autoReset=_,j.enabled=L,j.autoUpdate=F,j.needsUpdate=O,j.type=U}function he(_){ot("WebGLRenderer: A WebGL context could not be created. Reason: ",_.statusMessage)}function we(_){const L=_.target;L.removeEventListener("dispose",we),et(L)}function et(_){Ye(_),Se.remove(_)}function Ye(_){const L=Se.get(_).programs;L!==void 0&&(L.forEach(function(F){V.releaseProgram(F)}),_.isShaderMaterial&&V.releaseShaderCache(_))}this.renderBufferDirect=function(_,L,F,O,U,$){L===null&&(L=pt);const ce=U.isMesh&&U.matrixWorld.determinant()<0,pe=So(_,L,F,O,U);me.setMaterial(O,ce);let fe=F.index,ye=1;if(O.wireframe===!0){if(fe=W.getWireframeAttribute(F),fe===void 0)return;ye=2}const Re=F.drawRange,ve=F.attributes.position;let Ve=Re.start*ye,Ke=(Re.start+Re.count)*ye;$!==null&&(Ve=Math.max(Ve,$.start*ye),Ke=Math.min(Ke,($.start+$.count)*ye)),fe!==null?(Ve=Math.max(Ve,0),Ke=Math.min(Ke,fe.count)):ve!=null&&(Ve=Math.max(Ve,0),Ke=Math.min(Ke,ve.count));const at=Ke-Ve;if(at<0||at===1/0)return;C.setup(U,O,pe,F,fe);let st,Je=Te;if(fe!==null&&(st=N.get(fe),Je=ue,Je.setIndex(st)),U.isMesh)O.wireframe===!0?(me.setLineWidth(O.wireframeLinewidth*tt()),Je.setMode(A.LINES)):Je.setMode(A.TRIANGLES);else if(U.isLine){let be=O.linewidth;be===void 0&&(be=1),me.setLineWidth(be*tt()),U.isLineSegments?Je.setMode(A.LINES):U.isLineLoop?Je.setMode(A.LINE_LOOP):Je.setMode(A.LINE_STRIP)}else U.isPoints?Je.setMode(A.POINTS):U.isSprite&&Je.setMode(A.TRIANGLES);if(U.isBatchedMesh)if(U._multiDrawInstances!==null)Si("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Je.renderMultiDrawInstances(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount,U._multiDrawInstances);else if(ze.get("WEBGL_multi_draw"))Je.renderMultiDraw(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount);else{const be=U._multiDrawStarts,it=U._multiDrawCounts,ke=U._multiDrawCount,yt=fe?N.get(fe).bytesPerElement:1,Nn=Se.get(O).currentProgram.getUniforms();for(let At=0;At<ke;At++)Nn.setValue(A,"_gl_DrawID",At),Je.render(be[At]/yt,it[At])}else if(U.isInstancedMesh)Je.renderInstances(Ve,at,U.count);else if(F.isInstancedBufferGeometry){const be=F._maxInstanceCount!==void 0?F._maxInstanceCount:1/0,it=Math.min(F.instanceCount,be);Je.renderInstances(Ve,at,it)}else Je.render(Ve,at)};function Gt(_,L,F){_.transparent===!0&&_.side===en&&_.forceSinglePass===!1?(_.side=Tt,_.needsUpdate=!0,Ri(_,L,F),_.side=_n,_.needsUpdate=!0,Ri(_,L,F),_.side=en):Ri(_,L,F)}this.compile=function(_,L,F=null){F===null&&(F=_),T=Ee.get(F),T.init(L),P.push(T),F.traverseVisible(function(U){U.isLight&&U.layers.test(L.layers)&&(T.pushLight(U),U.castShadow&&T.pushShadow(U))}),_!==F&&_.traverseVisible(function(U){U.isLight&&U.layers.test(L.layers)&&(T.pushLight(U),U.castShadow&&T.pushShadow(U))}),T.setupLights();const O=new Set;return _.traverse(function(U){if(!(U.isMesh||U.isPoints||U.isLine||U.isSprite))return;const $=U.material;if($)if(Array.isArray($))for(let ce=0;ce<$.length;ce++){const pe=$[ce];Gt(pe,F,U),O.add(pe)}else Gt($,F,U),O.add($)}),T=P.pop(),O},this.compileAsync=function(_,L,F=null){const O=this.compile(_,L,F);return new Promise(U=>{function $(){if(O.forEach(function(ce){Se.get(ce).currentProgram.isReady()&&O.delete(ce)}),O.size===0){U(_);return}setTimeout($,10)}ze.get("KHR_parallel_shader_compile")!==null?$():setTimeout($,10)})};let It=null;function vo(_){It&&It(_)}function Ba(){vn.stop()}function za(){vn.start()}const vn=new po;vn.setAnimationLoop(vo),typeof self<"u"&&vn.setContext(self),this.setAnimationLoop=function(_){It=_,re.setAnimationLoop(_),_===null?vn.stop():vn.start()},re.addEventListener("sessionstart",Ba),re.addEventListener("sessionend",za),this.render=function(_,L){if(L!==void 0&&L.isCamera!==!0){ot("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(_.matrixWorldAutoUpdate===!0&&_.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),re.enabled===!0&&re.isPresenting===!0&&(re.cameraAutoUpdate===!0&&re.updateCamera(L),L=re.getCamera()),_.isScene===!0&&_.onBeforeRender(b,_,L,v),T=Ee.get(_,P.length),T.init(L),P.push(T),Le.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),X.setFromProjectionMatrix(Le,Wt,L.reversedDepth),de=this.localClippingEnabled,J=xe.init(this.clippingPlanes,de),y=oe.get(_,R.length),y.init(),R.push(y),re.enabled===!0&&re.isPresenting===!0){const $=b.xr.getDepthSensingMesh();$!==null&&sr($,L,-1/0,b.sortObjects)}sr(_,L,0,b.sortObjects),y.finish(),b.sortObjects===!0&&y.sort(Me,He),Fe=re.enabled===!1||re.isPresenting===!1||re.hasDepthSensing()===!1,Fe&&ee.addToRenderList(y,_),this.info.render.frame++,J===!0&&xe.beginShadows();const F=T.state.shadowsArray;j.render(F,_,L),J===!0&&xe.endShadows(),this.info.autoReset===!0&&this.info.reset();const O=y.opaque,U=y.transmissive;if(T.setupLights(),L.isArrayCamera){const $=L.cameras;if(U.length>0)for(let ce=0,pe=$.length;ce<pe;ce++){const fe=$[ce];Ga(O,U,_,fe)}Fe&&ee.render(_);for(let ce=0,pe=$.length;ce<pe;ce++){const fe=$[ce];Va(y,_,fe,fe.viewport)}}else U.length>0&&Ga(O,U,_,L),Fe&&ee.render(_),Va(y,_,L);v!==null&&M===0&&(De.updateMultisampleRenderTarget(v),De.updateRenderTargetMipmap(v)),_.isScene===!0&&_.onAfterRender(b,_,L),C.resetDefaultState(),w=-1,I=null,P.pop(),P.length>0?(T=P[P.length-1],J===!0&&xe.setGlobalState(b.clippingPlanes,T.state.camera)):T=null,R.pop(),R.length>0?y=R[R.length-1]:y=null};function sr(_,L,F,O){if(_.visible===!1)return;if(_.layers.test(L.layers)){if(_.isGroup)F=_.renderOrder;else if(_.isLOD)_.autoUpdate===!0&&_.update(L);else if(_.isLight)T.pushLight(_),_.castShadow&&T.pushShadow(_);else if(_.isSprite){if(!_.frustumCulled||X.intersectsSprite(_)){O&&Oe.setFromMatrixPosition(_.matrixWorld).applyMatrix4(Le);const ce=Z.update(_),pe=_.material;pe.visible&&y.push(_,ce,pe,F,Oe.z,null)}}else if((_.isMesh||_.isLine||_.isPoints)&&(!_.frustumCulled||X.intersectsObject(_))){const ce=Z.update(_),pe=_.material;if(O&&(_.boundingSphere!==void 0?(_.boundingSphere===null&&_.computeBoundingSphere(),Oe.copy(_.boundingSphere.center)):(ce.boundingSphere===null&&ce.computeBoundingSphere(),Oe.copy(ce.boundingSphere.center)),Oe.applyMatrix4(_.matrixWorld).applyMatrix4(Le)),Array.isArray(pe)){const fe=ce.groups;for(let ye=0,Re=fe.length;ye<Re;ye++){const ve=fe[ye],Ve=pe[ve.materialIndex];Ve&&Ve.visible&&y.push(_,ce,Ve,F,Oe.z,ve)}}else pe.visible&&y.push(_,ce,pe,F,Oe.z,null)}}const $=_.children;for(let ce=0,pe=$.length;ce<pe;ce++)sr($[ce],L,F,O)}function Va(_,L,F,O){const{opaque:U,transmissive:$,transparent:ce}=_;T.setupLightsView(F),J===!0&&xe.setGlobalState(b.clippingPlanes,F),O&&me.viewport(G.copy(O)),U.length>0&&Ai(U,L,F),$.length>0&&Ai($,L,F),ce.length>0&&Ai(ce,L,F),me.buffers.depth.setTest(!0),me.buffers.depth.setMask(!0),me.buffers.color.setMask(!0),me.setPolygonOffset(!1)}function Ga(_,L,F,O){if((F.isScene===!0?F.overrideMaterial:null)!==null)return;T.state.transmissionRenderTarget[O.id]===void 0&&(T.state.transmissionRenderTarget[O.id]=new In(1,1,{generateMipmaps:!0,type:ze.has("EXT_color_buffer_half_float")||ze.has("EXT_color_buffer_float")?ri:sn,minFilter:Dn,samples:4,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:We.workingColorSpace}));const $=T.state.transmissionRenderTarget[O.id],ce=O.viewport||G;$.setSize(ce.z*b.transmissionResolutionScale,ce.w*b.transmissionResolutionScale);const pe=b.getRenderTarget(),fe=b.getActiveCubeFace(),ye=b.getActiveMipmapLevel();b.setRenderTarget($),b.getClearColor(q),ne=b.getClearAlpha(),ne<1&&b.setClearColor(16777215,.5),b.clear(),Fe&&ee.render(F);const Re=b.toneMapping;b.toneMapping=xn;const ve=O.viewport;if(O.viewport!==void 0&&(O.viewport=void 0),T.setupLightsView(O),J===!0&&xe.setGlobalState(b.clippingPlanes,O),Ai(_,F,O),De.updateMultisampleRenderTarget($),De.updateRenderTargetMipmap($),ze.has("WEBGL_multisampled_render_to_texture")===!1){let Ve=!1;for(let Ke=0,at=L.length;Ke<at;Ke++){const st=L[Ke],{object:Je,geometry:be,material:it,group:ke}=st;if(it.side===en&&Je.layers.test(O.layers)){const yt=it.side;it.side=Tt,it.needsUpdate=!0,Ha(Je,F,O,be,it,ke),it.side=yt,it.needsUpdate=!0,Ve=!0}}Ve===!0&&(De.updateMultisampleRenderTarget($),De.updateRenderTargetMipmap($))}b.setRenderTarget(pe,fe,ye),b.setClearColor(q,ne),ve!==void 0&&(O.viewport=ve),b.toneMapping=Re}function Ai(_,L,F){const O=L.isScene===!0?L.overrideMaterial:null;for(let U=0,$=_.length;U<$;U++){const ce=_[U],{object:pe,geometry:fe,group:ye}=ce;let Re=ce.material;Re.allowOverride===!0&&O!==null&&(Re=O),pe.layers.test(F.layers)&&Ha(pe,L,F,fe,Re,ye)}}function Ha(_,L,F,O,U,$){_.onBeforeRender(b,L,F,O,U,$),_.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,_.matrixWorld),_.normalMatrix.getNormalMatrix(_.modelViewMatrix),U.onBeforeRender(b,L,F,O,_,$),U.transparent===!0&&U.side===en&&U.forceSinglePass===!1?(U.side=Tt,U.needsUpdate=!0,b.renderBufferDirect(F,L,O,U,_,$),U.side=_n,U.needsUpdate=!0,b.renderBufferDirect(F,L,O,U,_,$),U.side=en):b.renderBufferDirect(F,L,O,U,_,$),_.onAfterRender(b,L,F,O,U,$)}function Ri(_,L,F){L.isScene!==!0&&(L=pt);const O=Se.get(_),U=T.state.lights,$=T.state.shadowsArray,ce=U.state.version,pe=V.getParameters(_,U.state,$,L,F),fe=V.getProgramCacheKey(pe);let ye=O.programs;O.environment=_.isMeshStandardMaterial?L.environment:null,O.fog=L.fog,O.envMap=(_.isMeshStandardMaterial?x:E).get(_.envMap||O.environment),O.envMapRotation=O.environment!==null&&_.envMap===null?L.environmentRotation:_.envMapRotation,ye===void 0&&(_.addEventListener("dispose",we),ye=new Map,O.programs=ye);let Re=ye.get(fe);if(Re!==void 0){if(O.currentProgram===Re&&O.lightsStateVersion===ce)return Wa(_,pe),Re}else pe.uniforms=V.getUniforms(_),_.onBeforeCompile(pe,b),Re=V.acquireProgram(pe,fe),ye.set(fe,Re),O.uniforms=pe.uniforms;const ve=O.uniforms;return(!_.isShaderMaterial&&!_.isRawShaderMaterial||_.clipping===!0)&&(ve.clippingPlanes=xe.uniform),Wa(_,pe),O.needsLights=Eo(_),O.lightsStateVersion=ce,O.needsLights&&(ve.ambientLightColor.value=U.state.ambient,ve.lightProbe.value=U.state.probe,ve.directionalLights.value=U.state.directional,ve.directionalLightShadows.value=U.state.directionalShadow,ve.spotLights.value=U.state.spot,ve.spotLightShadows.value=U.state.spotShadow,ve.rectAreaLights.value=U.state.rectArea,ve.ltc_1.value=U.state.rectAreaLTC1,ve.ltc_2.value=U.state.rectAreaLTC2,ve.pointLights.value=U.state.point,ve.pointLightShadows.value=U.state.pointShadow,ve.hemisphereLights.value=U.state.hemi,ve.directionalShadowMap.value=U.state.directionalShadowMap,ve.directionalShadowMatrix.value=U.state.directionalShadowMatrix,ve.spotShadowMap.value=U.state.spotShadowMap,ve.spotLightMatrix.value=U.state.spotLightMatrix,ve.spotLightMap.value=U.state.spotLightMap,ve.pointShadowMap.value=U.state.pointShadowMap,ve.pointShadowMatrix.value=U.state.pointShadowMatrix),O.currentProgram=Re,O.uniformsList=null,Re}function ka(_){if(_.uniformsList===null){const L=_.currentProgram.getUniforms();_.uniformsList=$i.seqWithValue(L.seq,_.uniforms)}return _.uniformsList}function Wa(_,L){const F=Se.get(_);F.outputColorSpace=L.outputColorSpace,F.batching=L.batching,F.batchingColor=L.batchingColor,F.instancing=L.instancing,F.instancingColor=L.instancingColor,F.instancingMorph=L.instancingMorph,F.skinning=L.skinning,F.morphTargets=L.morphTargets,F.morphNormals=L.morphNormals,F.morphColors=L.morphColors,F.morphTargetsCount=L.morphTargetsCount,F.numClippingPlanes=L.numClippingPlanes,F.numIntersection=L.numClipIntersection,F.vertexAlphas=L.vertexAlphas,F.vertexTangents=L.vertexTangents,F.toneMapping=L.toneMapping}function So(_,L,F,O,U){L.isScene!==!0&&(L=pt),De.resetTextureUnits();const $=L.fog,ce=O.isMeshStandardMaterial?L.environment:null,pe=v===null?b.outputColorSpace:v.isXRRenderTarget===!0?v.texture.colorSpace:ni,fe=(O.isMeshStandardMaterial?x:E).get(O.envMap||ce),ye=O.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,Re=!!F.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),ve=!!F.morphAttributes.position,Ve=!!F.morphAttributes.normal,Ke=!!F.morphAttributes.color;let at=xn;O.toneMapped&&(v===null||v.isXRRenderTarget===!0)&&(at=b.toneMapping);const st=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,Je=st!==void 0?st.length:0,be=Se.get(O),it=T.state.lights;if(J===!0&&(de===!0||_!==I)){const gt=_===I&&O.id===w;xe.setState(O,_,gt)}let ke=!1;O.version===be.__version?(be.needsLights&&be.lightsStateVersion!==it.state.version||be.outputColorSpace!==pe||U.isBatchedMesh&&be.batching===!1||!U.isBatchedMesh&&be.batching===!0||U.isBatchedMesh&&be.batchingColor===!0&&U.colorTexture===null||U.isBatchedMesh&&be.batchingColor===!1&&U.colorTexture!==null||U.isInstancedMesh&&be.instancing===!1||!U.isInstancedMesh&&be.instancing===!0||U.isSkinnedMesh&&be.skinning===!1||!U.isSkinnedMesh&&be.skinning===!0||U.isInstancedMesh&&be.instancingColor===!0&&U.instanceColor===null||U.isInstancedMesh&&be.instancingColor===!1&&U.instanceColor!==null||U.isInstancedMesh&&be.instancingMorph===!0&&U.morphTexture===null||U.isInstancedMesh&&be.instancingMorph===!1&&U.morphTexture!==null||be.envMap!==fe||O.fog===!0&&be.fog!==$||be.numClippingPlanes!==void 0&&(be.numClippingPlanes!==xe.numPlanes||be.numIntersection!==xe.numIntersection)||be.vertexAlphas!==ye||be.vertexTangents!==Re||be.morphTargets!==ve||be.morphNormals!==Ve||be.morphColors!==Ke||be.toneMapping!==at||be.morphTargetsCount!==Je)&&(ke=!0):(ke=!0,be.__version=O.version);let yt=be.currentProgram;ke===!0&&(yt=Ri(O,L,U));let Nn=!1,At=!1,oi=!1;const rt=yt.getUniforms(),St=be.uniforms;if(me.useProgram(yt.program)&&(Nn=!0,At=!0,oi=!0),O.id!==w&&(w=O.id,At=!0),Nn||I!==_){me.buffers.depth.getReversed()&&_.reversedDepth!==!0&&(_._reversedDepth=!0,_.updateProjectionMatrix()),rt.setValue(A,"projectionMatrix",_.projectionMatrix),rt.setValue(A,"viewMatrix",_.matrixWorldInverse);const Mt=rt.map.cameraPosition;Mt!==void 0&&Mt.setValue(A,ge.setFromMatrixPosition(_.matrixWorld)),$e.logarithmicDepthBuffer&&rt.setValue(A,"logDepthBufFC",2/(Math.log(_.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&rt.setValue(A,"isOrthographic",_.isOrthographicCamera===!0),I!==_&&(I=_,At=!0,oi=!0)}if(U.isSkinnedMesh){rt.setOptional(A,U,"bindMatrix"),rt.setOptional(A,U,"bindMatrixInverse");const gt=U.skeleton;gt&&(gt.boneTexture===null&&gt.computeBoneTexture(),rt.setValue(A,"boneTexture",gt.boneTexture,De))}U.isBatchedMesh&&(rt.setOptional(A,U,"batchingTexture"),rt.setValue(A,"batchingTexture",U._matricesTexture,De),rt.setOptional(A,U,"batchingIdTexture"),rt.setValue(A,"batchingIdTexture",U._indirectTexture,De),rt.setOptional(A,U,"batchingColorTexture"),U._colorsTexture!==null&&rt.setValue(A,"batchingColorTexture",U._colorsTexture,De));const Dt=F.morphAttributes;if((Dt.position!==void 0||Dt.normal!==void 0||Dt.color!==void 0)&&Ae.update(U,F,yt),(At||be.receiveShadow!==U.receiveShadow)&&(be.receiveShadow=U.receiveShadow,rt.setValue(A,"receiveShadow",U.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(St.envMap.value=fe,St.flipEnvMap.value=fe.isCubeTexture&&fe.isRenderTargetTexture===!1?-1:1),O.isMeshStandardMaterial&&O.envMap===null&&L.environment!==null&&(St.envMapIntensity.value=L.environmentIntensity),St.dfgLUT!==void 0&&(St.dfgLUT.value=Jh()),At&&(rt.setValue(A,"toneMappingExposure",b.toneMappingExposure),be.needsLights&&Mo(St,oi),$&&O.fog===!0&&_e.refreshFogUniforms(St,$),_e.refreshMaterialUniforms(St,O,ae,te,T.state.transmissionRenderTarget[_.id]),$i.upload(A,ka(be),St,De)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&($i.upload(A,ka(be),St,De),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&rt.setValue(A,"center",U.center),rt.setValue(A,"modelViewMatrix",U.modelViewMatrix),rt.setValue(A,"normalMatrix",U.normalMatrix),rt.setValue(A,"modelMatrix",U.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const gt=O.uniformsGroups;for(let Mt=0,or=gt.length;Mt<or;Mt++){const Sn=gt[Mt];le.update(Sn,yt),le.bind(Sn,yt)}}return yt}function Mo(_,L){_.ambientLightColor.needsUpdate=L,_.lightProbe.needsUpdate=L,_.directionalLights.needsUpdate=L,_.directionalLightShadows.needsUpdate=L,_.pointLights.needsUpdate=L,_.pointLightShadows.needsUpdate=L,_.spotLights.needsUpdate=L,_.spotLightShadows.needsUpdate=L,_.rectAreaLights.needsUpdate=L,_.hemisphereLights.needsUpdate=L}function Eo(_){return _.isMeshLambertMaterial||_.isMeshToonMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isShadowMaterial||_.isShaderMaterial&&_.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return M},this.getRenderTarget=function(){return v},this.setRenderTargetTextures=function(_,L,F){const O=Se.get(_);O.__autoAllocateDepthBuffer=_.resolveDepthBuffer===!1,O.__autoAllocateDepthBuffer===!1&&(O.__useRenderToTexture=!1),Se.get(_.texture).__webglTexture=L,Se.get(_.depthTexture).__webglTexture=O.__autoAllocateDepthBuffer?void 0:F,O.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(_,L){const F=Se.get(_);F.__webglFramebuffer=L,F.__useDefaultFramebuffer=L===void 0};const bo=A.createFramebuffer();this.setRenderTarget=function(_,L=0,F=0){v=_,B=L,M=F;let O=!0,U=null,$=!1,ce=!1;if(_){const fe=Se.get(_);if(fe.__useDefaultFramebuffer!==void 0)me.bindFramebuffer(A.FRAMEBUFFER,null),O=!1;else if(fe.__webglFramebuffer===void 0)De.setupRenderTarget(_);else if(fe.__hasExternalTextures)De.rebindTextures(_,Se.get(_.texture).__webglTexture,Se.get(_.depthTexture).__webglTexture);else if(_.depthBuffer){const ve=_.depthTexture;if(fe.__boundDepthTexture!==ve){if(ve!==null&&Se.has(ve)&&(_.width!==ve.image.width||_.height!==ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");De.setupDepthRenderbuffer(_)}}const ye=_.texture;(ye.isData3DTexture||ye.isDataArrayTexture||ye.isCompressedArrayTexture)&&(ce=!0);const Re=Se.get(_).__webglFramebuffer;_.isWebGLCubeRenderTarget?(Array.isArray(Re[L])?U=Re[L][F]:U=Re[L],$=!0):_.samples>0&&De.useMultisampledRTT(_)===!1?U=Se.get(_).__webglMultisampledFramebuffer:Array.isArray(Re)?U=Re[F]:U=Re,G.copy(_.viewport),k.copy(_.scissor),K=_.scissorTest}else G.copy(qe).multiplyScalar(ae).floor(),k.copy(je).multiplyScalar(ae).floor(),K=Qe;if(F!==0&&(U=bo),me.bindFramebuffer(A.FRAMEBUFFER,U)&&O&&me.drawBuffers(_,U),me.viewport(G),me.scissor(k),me.setScissorTest(K),$){const fe=Se.get(_.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+L,fe.__webglTexture,F)}else if(ce){const fe=L;for(let ye=0;ye<_.textures.length;ye++){const Re=Se.get(_.textures[ye]);A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0+ye,Re.__webglTexture,F,fe)}}else if(_!==null&&F!==0){const fe=Se.get(_.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,fe.__webglTexture,F)}w=-1},this.readRenderTargetPixels=function(_,L,F,O,U,$,ce,pe=0){if(!(_&&_.isWebGLRenderTarget)){ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let fe=Se.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&ce!==void 0&&(fe=fe[ce]),fe){me.bindFramebuffer(A.FRAMEBUFFER,fe);try{const ye=_.textures[pe],Re=ye.format,ve=ye.type;if(!$e.textureFormatReadable(Re)){ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!$e.textureTypeReadable(ve)){ot("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=_.width-O&&F>=0&&F<=_.height-U&&(_.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+pe),A.readPixels(L,F,O,U,Ce.convert(Re),Ce.convert(ve),$))}finally{const ye=v!==null?Se.get(v).__webglFramebuffer:null;me.bindFramebuffer(A.FRAMEBUFFER,ye)}}},this.readRenderTargetPixelsAsync=async function(_,L,F,O,U,$,ce,pe=0){if(!(_&&_.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let fe=Se.get(_).__webglFramebuffer;if(_.isWebGLCubeRenderTarget&&ce!==void 0&&(fe=fe[ce]),fe)if(L>=0&&L<=_.width-O&&F>=0&&F<=_.height-U){me.bindFramebuffer(A.FRAMEBUFFER,fe);const ye=_.textures[pe],Re=ye.format,ve=ye.type;if(!$e.textureFormatReadable(Re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!$e.textureTypeReadable(ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ve=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,Ve),A.bufferData(A.PIXEL_PACK_BUFFER,$.byteLength,A.STREAM_READ),_.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+pe),A.readPixels(L,F,O,U,Ce.convert(Re),Ce.convert(ve),0);const Ke=v!==null?Se.get(v).__webglFramebuffer:null;me.bindFramebuffer(A.FRAMEBUFFER,Ke);const at=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await Tl(A,at,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,Ve),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,$),A.deleteBuffer(Ve),A.deleteSync(at),$}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(_,L=null,F=0){const O=Math.pow(2,-F),U=Math.floor(_.image.width*O),$=Math.floor(_.image.height*O),ce=L!==null?L.x:0,pe=L!==null?L.y:0;De.setTexture2D(_,0),A.copyTexSubImage2D(A.TEXTURE_2D,F,0,0,ce,pe,U,$),me.unbindTexture()};const To=A.createFramebuffer(),yo=A.createFramebuffer();this.copyTextureToTexture=function(_,L,F=null,O=null,U=0,$=null){$===null&&(U!==0?(Si("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),$=U,U=0):$=0);let ce,pe,fe,ye,Re,ve,Ve,Ke,at;const st=_.isCompressedTexture?_.mipmaps[$]:_.image;if(F!==null)ce=F.max.x-F.min.x,pe=F.max.y-F.min.y,fe=F.isBox3?F.max.z-F.min.z:1,ye=F.min.x,Re=F.min.y,ve=F.isBox3?F.min.z:0;else{const Dt=Math.pow(2,-U);ce=Math.floor(st.width*Dt),pe=Math.floor(st.height*Dt),_.isDataArrayTexture?fe=st.depth:_.isData3DTexture?fe=Math.floor(st.depth*Dt):fe=1,ye=0,Re=0,ve=0}O!==null?(Ve=O.x,Ke=O.y,at=O.z):(Ve=0,Ke=0,at=0);const Je=Ce.convert(L.format),be=Ce.convert(L.type);let it;L.isData3DTexture?(De.setTexture3D(L,0),it=A.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(De.setTexture2DArray(L,0),it=A.TEXTURE_2D_ARRAY):(De.setTexture2D(L,0),it=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,L.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,L.unpackAlignment);const ke=A.getParameter(A.UNPACK_ROW_LENGTH),yt=A.getParameter(A.UNPACK_IMAGE_HEIGHT),Nn=A.getParameter(A.UNPACK_SKIP_PIXELS),At=A.getParameter(A.UNPACK_SKIP_ROWS),oi=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,st.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,st.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,ye),A.pixelStorei(A.UNPACK_SKIP_ROWS,Re),A.pixelStorei(A.UNPACK_SKIP_IMAGES,ve);const rt=_.isDataArrayTexture||_.isData3DTexture,St=L.isDataArrayTexture||L.isData3DTexture;if(_.isDepthTexture){const Dt=Se.get(_),gt=Se.get(L),Mt=Se.get(Dt.__renderTarget),or=Se.get(gt.__renderTarget);me.bindFramebuffer(A.READ_FRAMEBUFFER,Mt.__webglFramebuffer),me.bindFramebuffer(A.DRAW_FRAMEBUFFER,or.__webglFramebuffer);for(let Sn=0;Sn<fe;Sn++)rt&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Se.get(_).__webglTexture,U,ve+Sn),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Se.get(L).__webglTexture,$,at+Sn)),A.blitFramebuffer(ye,Re,ce,pe,Ve,Ke,ce,pe,A.DEPTH_BUFFER_BIT,A.NEAREST);me.bindFramebuffer(A.READ_FRAMEBUFFER,null),me.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(U!==0||_.isRenderTargetTexture||Se.has(_)){const Dt=Se.get(_),gt=Se.get(L);me.bindFramebuffer(A.READ_FRAMEBUFFER,To),me.bindFramebuffer(A.DRAW_FRAMEBUFFER,yo);for(let Mt=0;Mt<fe;Mt++)rt?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Dt.__webglTexture,U,ve+Mt):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Dt.__webglTexture,U),St?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,gt.__webglTexture,$,at+Mt):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,gt.__webglTexture,$),U!==0?A.blitFramebuffer(ye,Re,ce,pe,Ve,Ke,ce,pe,A.COLOR_BUFFER_BIT,A.NEAREST):St?A.copyTexSubImage3D(it,$,Ve,Ke,at+Mt,ye,Re,ce,pe):A.copyTexSubImage2D(it,$,Ve,Ke,ye,Re,ce,pe);me.bindFramebuffer(A.READ_FRAMEBUFFER,null),me.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else St?_.isDataTexture||_.isData3DTexture?A.texSubImage3D(it,$,Ve,Ke,at,ce,pe,fe,Je,be,st.data):L.isCompressedArrayTexture?A.compressedTexSubImage3D(it,$,Ve,Ke,at,ce,pe,fe,Je,st.data):A.texSubImage3D(it,$,Ve,Ke,at,ce,pe,fe,Je,be,st):_.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,$,Ve,Ke,ce,pe,Je,be,st.data):_.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,$,Ve,Ke,st.width,st.height,Je,st.data):A.texSubImage2D(A.TEXTURE_2D,$,Ve,Ke,ce,pe,Je,be,st);A.pixelStorei(A.UNPACK_ROW_LENGTH,ke),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,yt),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Nn),A.pixelStorei(A.UNPACK_SKIP_ROWS,At),A.pixelStorei(A.UNPACK_SKIP_IMAGES,oi),$===0&&L.generateMipmaps&&A.generateMipmap(it),me.unbindTexture()},this.initRenderTarget=function(_){Se.get(_).__webglFramebuffer===void 0&&De.setupRenderTarget(_)},this.initTexture=function(_){_.isCubeTexture?De.setTextureCube(_,0):_.isData3DTexture?De.setTexture3D(_,0):_.isDataArrayTexture||_.isCompressedArrayTexture?De.setTexture2DArray(_,0):De.setTexture2D(_,0),me.unbindTexture()},this.resetState=function(){B=0,M=0,v=null,me.reset(),C.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Wt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=We._getDrawingBufferColorSpace(e),t.unpackColorSpace=We._getUnpackColorSpace()}}var Qh=Ao('<div class="fixed inset-0 -z-10 w-full h-full"><canvas class="w-full h-full block"></canvas></div>');function ip(i,e){Po(e,!0);let t,n,r,a,s,o,c,l,u=0,d=0;const h={bgColor:new Pe,lightColor1:new Pe,lightColor2:new Pe,cloudBaseCol:new Pe,cloudShadowCol:new Pe,sunGlowCol:new Pe,sunCoreCol:new Pe,sunGlareCol:new Pe},p=`
        varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = vec4(position, 1.0);
    ...
    `;Co(()=>{if(!t||!n)return;r=new jh({canvas:n,antialias:!1,powerPreference:"high-performance",alpha:!1});const T=new ho(-1,1,1,-1,0,1),R=new jl,P=new yi(2,2),b=new oc;c=b.load("/textures/noise.png"),c.wrapS=Pn,c.wrapT=Pn,c.minFilter=Ja,c.magFilter=bt,c.generateMipmaps=!0,c.colorSpace=kt,l=b.load("/textures/blue_noise.png"),l.wrapS=Pn,l.wrapT=Pn,l.minFilter=Ja,l.magFilter=bt,l.generateMipmaps=!0,l.colorSpace=kt,a=new qt({vertexShader:p,fragmentShader:m,uniforms:{iTime:{value:0},uCamZ:{value:0},uVortexPhase:{value:0},iResolution:{value:new z(1,1,1)},iChannel0:{value:c},iChannel1:{value:l},LOOK:{value:e.params.look},NOISE_METHOD:{value:e.params.noiseMethod},USE_LOD:{value:e.params.useLod},RENDER_STEPS:{value:e.params.renderSteps},DRAW_DIST:{value:e.params.drawDist},CAM_SPEED:{value:e.params.camSpeed},CAM_FOV:{value:e.params.camFov},CAM_ROLL_AMP:{value:e.params.camRollAmp},CAM_ROLL_FREQ:{value:e.params.camRollFreq},CAM_LOOK_AHEAD:{value:e.params.camLookAhead},SUN_PATH_OFFSET:{value:e.params.sunPathOffset},TUNNEL_RADIUS:{value:e.params.tunnelRadius},PATH_AMP_X:{value:e.params.pathAmpX},PATH_FREQ_X:{value:e.params.pathFreqX},PATH_AMP_Y:{value:e.params.pathAmpY},PATH_FREQ_Y:{value:e.params.pathFreqY},VORTEX_SPEED:{value:e.params.vortexSpeed},VORTEX_TWIST:{value:e.params.vortexTwist},NOISE_SCALE_BASE:{value:e.params.noiseScaleBase},NOISE_SCALE_DET:{value:e.params.noiseScaleDet},CLOUD_DENSITY:{value:e.params.cloudDensity},BG_COLOR:{value:new Pe(e.params.bgColor)},LIGHT_COLOR_1:{value:new Pe(e.params.lightColor1)},LIGHT_COLOR_2:{value:new Pe(e.params.lightColor2)},CLOUD_BASE_COL:{value:new Pe(e.params.cloudBaseCol)},CLOUD_SHADOW_COL:{value:new Pe(e.params.cloudShadowCol)},FOG_DENSITY:{value:e.params.fogDensity},SUN_GLOW_COL:{value:new Pe(e.params.sunGlowCol)},SUN_GLOW_POW:{value:e.params.sunGlowPow},SUN_CORE_COL:{value:new Pe(e.params.sunCoreCol)},SUN_CORE_POW:{value:e.params.sunCorePow},SUN_GLARE_COL:{value:new Pe(e.params.sunGlareCol)},SUN_GLARE_POW:{value:e.params.sunGlarePow}}});const D=new ln(P,a);R.add(D);const B=()=>{if(!t||!r)return;const w=t.clientWidth,I=t.clientHeight,G=Math.min(window.devicePixelRatio,e.params.pixelRatioCap);r.setPixelRatio(G),r.setSize(w*e.params.renderScale,I*e.params.renderScale,!1),n.style.width=`${w}px`,n.style.height=`${I}px`;const k=new Xe;r.getDrawingBufferSize(k),a.uniforms.iResolution.value.set(k.x,k.y,1)};o=new ResizeObserver(B),o.observe(t);const M=new cc,v=()=>{if(s=requestAnimationFrame(v),a){const w=M.getDelta();a.uniforms.iTime.value=M.elapsedTime;const I=1-Math.exp(-w*5);a.uniforms.CAM_SPEED.value+=(e.params.camSpeed-a.uniforms.CAM_SPEED.value)*I,a.uniforms.CAM_FOV.value+=(e.params.camFov-a.uniforms.CAM_FOV.value)*I,a.uniforms.CAM_ROLL_AMP.value+=(e.params.camRollAmp-a.uniforms.CAM_ROLL_AMP.value)*I,a.uniforms.CAM_ROLL_FREQ.value+=(e.params.camRollFreq-a.uniforms.CAM_ROLL_FREQ.value)*I,a.uniforms.CAM_LOOK_AHEAD.value+=(e.params.camLookAhead-a.uniforms.CAM_LOOK_AHEAD.value)*I,a.uniforms.SUN_PATH_OFFSET.value+=(e.params.sunPathOffset-a.uniforms.SUN_PATH_OFFSET.value)*I,a.uniforms.TUNNEL_RADIUS.value+=(e.params.tunnelRadius-a.uniforms.TUNNEL_RADIUS.value)*I,a.uniforms.PATH_AMP_X.value+=(e.params.pathAmpX-a.uniforms.PATH_AMP_X.value)*I,a.uniforms.PATH_FREQ_X.value+=(e.params.pathFreqX-a.uniforms.PATH_FREQ_X.value)*I,a.uniforms.PATH_AMP_Y.value+=(e.params.pathAmpY-a.uniforms.PATH_AMP_Y.value)*I,a.uniforms.PATH_FREQ_Y.value+=(e.params.pathFreqY-a.uniforms.PATH_FREQ_Y.value)*I,a.uniforms.VORTEX_SPEED.value+=(e.params.vortexSpeed-a.uniforms.VORTEX_SPEED.value)*I,a.uniforms.VORTEX_TWIST.value+=(e.params.vortexTwist-a.uniforms.VORTEX_TWIST.value)*I,a.uniforms.NOISE_SCALE_BASE.value+=(e.params.noiseScaleBase-a.uniforms.NOISE_SCALE_BASE.value)*I,a.uniforms.NOISE_SCALE_DET.value+=(e.params.noiseScaleDet-a.uniforms.NOISE_SCALE_DET.value)*I,a.uniforms.CLOUD_DENSITY.value+=(e.params.cloudDensity-a.uniforms.CLOUD_DENSITY.value)*I,a.uniforms.DRAW_DIST.value+=(e.params.drawDist-a.uniforms.DRAW_DIST.value)*I,a.uniforms.FOG_DENSITY.value+=(e.params.fogDensity-a.uniforms.FOG_DENSITY.value)*I,a.uniforms.SUN_GLOW_POW.value+=(e.params.sunGlowPow-a.uniforms.SUN_GLOW_POW.value)*I,a.uniforms.SUN_CORE_POW.value+=(e.params.sunCorePow-a.uniforms.SUN_CORE_POW.value)*I,a.uniforms.SUN_GLARE_POW.value+=(e.params.sunGlarePow-a.uniforms.SUN_GLARE_POW.value)*I,a.uniforms.BG_COLOR.value.lerp(h.bgColor,I),a.uniforms.LIGHT_COLOR_1.value.lerp(h.lightColor1,I),a.uniforms.LIGHT_COLOR_2.value.lerp(h.lightColor2,I),a.uniforms.CLOUD_BASE_COL.value.lerp(h.cloudBaseCol,I),a.uniforms.CLOUD_SHADOW_COL.value.lerp(h.cloudShadowCol,I),a.uniforms.SUN_GLOW_COL.value.lerp(h.sunGlowCol,I),a.uniforms.SUN_CORE_COL.value.lerp(h.sunCoreCol,I),a.uniforms.SUN_GLARE_COL.value.lerp(h.sunGlareCol,I),u+=w*a.uniforms.CAM_SPEED.value,d+=w*a.uniforms.VORTEX_SPEED.value,a.uniforms.uCamZ.value=u,a.uniforms.uVortexPhase.value=d}r.render(R,T)};v()}),Do(()=>{if(h.bgColor.set(e.params.bgColor),h.lightColor1.set(e.params.lightColor1),h.lightColor2.set(e.params.lightColor2),h.cloudBaseCol.set(e.params.cloudBaseCol),h.cloudShadowCol.set(e.params.cloudShadowCol),h.sunGlowCol.set(e.params.sunGlowCol),h.sunCoreCol.set(e.params.sunCoreCol),h.sunGlareCol.set(e.params.sunGlareCol),a&&(a.uniforms.LOOK.value=e.params.look,a.uniforms.NOISE_METHOD.value=e.params.noiseMethod,a.uniforms.USE_LOD.value=e.params.useLod,a.uniforms.RENDER_STEPS.value=e.params.renderSteps,t&&r)){r.getPixelRatio();const T=Math.min(window.devicePixelRatio,e.params.pixelRatioCap),R=t.clientWidth,P=t.clientHeight;r.setPixelRatio(T),r.setSize(R*e.params.renderScale,P*e.params.renderScale,!1),n.style.width=`${R}px`,n.style.height=`${P}px`;const b=new Xe;r.getDrawingBufferSize(b),a.uniforms.iResolution.value.set(b.x,b.y,1)}}),wo(()=>{s&&cancelAnimationFrame(s),o&&o.disconnect(),c&&c.dispose(),l&&l.dispose(),r&&r.dispose(),a&&a.dispose()});var f=Qh(),y=Lo(f);Xa(y,T=>n=T,()=>n),Uo(f),Xa(f,T=>t=T,()=>t),Ro(i,f),Io()}export{ip as default};
